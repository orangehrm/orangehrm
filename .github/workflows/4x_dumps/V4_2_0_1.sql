...
('beacon.uuid', '0'),
('csrf_secret', 'e66340576272250c1200467e7edf6c6158d2edb23374441e87114ec21068118b8742583b3d2a9fa1ff6fea2510dbd7444ab3143e90f5c4'),
('domain.name', 'localhost'),
('hsp_accrued_last_updated', '0000-00-00'),
('hsp_current_plan', '0'),
('hsp_used_last_updated', '0000-00-00'),
('include_supervisor_chain', 'No'),
('instance.identifier', 'T0hSTV9kZXZpQGFkbWluLmNvbV8yMDI0LTA1LTIxNDk='),
('ldap_domain_name', ''),
('ldap_port', ''),
('ldap_server', ''),
('ldap_status', ''),
...
(1, 1, 'Devi', 'Admin', 1, '2024-05-21 08:59:37');
...
(1, 1, 1, 'admin', '$2y$12$CgSrHQFa08ZdvtK.EsSWAu7q9I49dU9UPoqIb6Sphp50m0MAePr9u', 0, 1, NULL, NULL, NULL, NULL);
