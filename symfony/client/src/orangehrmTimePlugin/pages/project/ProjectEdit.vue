...
<template>
  <div class="orangehrm-background-container">
    <div class="orangehrm-card-container">
      <oxd-text tag="h6" class="orangehrm-main-title">Edit Project</oxd-text>
      <oxd-divider />
  ...
  methods: {
    ...
    onAddAnother() {
      if (this.projectAdmins.length < 5)
        this.projectAdmins.push(defaultProjectAdminModel);
    ...
    onSave() {
      ...
      project = {
        ...
        projectAdminsEmpNumbers: this.project.projectAdminEmpNumbers,
      };
      this.http
    ...
    //         .request({
    //           method: 'GET',
    //           url: `api/v2/time/validation/projectName`,
    //           params: {
    //             projectName: this.projectAdmins.name.trim(),
    //           },
    //         })
    //         .then(response => {
