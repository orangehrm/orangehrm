...
<script type="text/javascript">
    ...
    var lang_validDateMsg = '<?php echo __js(ValidationMessages::DATE_FORMAT_INVALID, array('%format%' => get_datepicker_date_format($sf_user->getDateFormat()))) ?>';
    var employees = <?php echo str_replace('&#039;', "'", $form->getEmployeeListAsJson()) ?> ;
    var employeeList = eval(employees);
    var numberOfInterviewers = <?php echo $form->numberOfInterviewers; ?>;
    var lang_identical_rows = "<?php echo __js("Already exists"); ?>";
    ...
    var lang_interviewHeadingRequired = '<?php echo __js(ValidationMessages::REQUIRED); ?>';
    var lang_interviewerRequired = '<?php echo __js(ValidationMessages::REQUIRED); ?>';
    var lang_noMoreThan98 = "<?php echo __js(ValidationMessages::TEXT_LENGTH_EXCEEDS, array('%amount%' => 100)); ?>";
    var lang_noMoreThan18 = "<?php echo __js(ValidationMessages::TEXT_LENGTH_EXCEEDS, array('%amount%' => 50)); ?>";
    var lang_enterAValidEmployeeName = "<?php echo __js(ValidationMessages::INVALID); ?>";
    var lang_dateRequired = '<?php echo __js(ValidationMessages::REQUIRED); ?>';
    var lang_validTimeRequired = "<?php echo __js(ValidationMessages::INVALID); ?>";
    var lang_viewInterviewDetails = "<?php echo __js('View Interview Details'); ?>";
    var lang_editInterviewDetails = "<?php echo __js('Edit Interview Details'); ?>";
