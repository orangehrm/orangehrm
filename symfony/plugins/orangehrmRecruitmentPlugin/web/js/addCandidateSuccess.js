...
$(document).ready(function() {
    ...
    if(candidateId != ""){
        ...
        '#addCandidate_appliedDate', '#frmDateBtn', '#addCandidate_comment', '#addCandidate_resumeUpdate_1', '#addCandidate_resumeUpdate_2','#addCandidate_resumeUpdate_3', '#addCandidate_appliedDate_Button', '#addCandidate_consentToKeepData');
        for(i=0; i < widgetList.length; i++) {
