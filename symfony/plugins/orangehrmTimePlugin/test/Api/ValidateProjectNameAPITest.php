...
class ValidateProjectNameAPITest extends EndpointIntegrationTestCase
{
    ...
    public function testGetOne(TestCaseParams $testCaseParams): void
    {
        ...
        $api = $this->getApiEndpointMock(ValidateProjectNameAPI::class, $testCaseParams);
        $this->assertValidTestCase($api, 'getOne', $testCaseParams);
    }

    public function dataProviderForTestGetOne(): array
    {
        return $this->getTestCases('ProjectNameTestCase.yaml', 'GetOne');
    }

    public function testUpdate(): void
    {
        $api = new ValidateProjectNameAPI($this->getRequest());
