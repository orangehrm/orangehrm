 ...
 * @group Service
 */
class LeaveCommentServiceTest extends TestCase
{
    ...
    public function testGetLeaveCommentDao(): void
    {
        $this->assertTrue($this->leaveCommentService->getLeaveCommentDao() instanceof LeaveCommentDao);
    }
}
