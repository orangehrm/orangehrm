...
('Purge Candidate Records', @module_id , 'purgeCandidate'),
...
set @purge_candidate_screen_id := (SELECT id FROM ohrm_screen WHERE action_url = 'purgeCandidate');
...
INSERT INTO ohrm_data_group_screen (data_group_id, screen_id, permission) VALUES
  ...
  (@data_group_id, @purge_candidate_screen_id, 1),
