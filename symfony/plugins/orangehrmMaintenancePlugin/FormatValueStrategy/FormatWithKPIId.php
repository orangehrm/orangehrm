...
class FormatWithKPIId implements ValueFormatter
{
    ...
    {
        return $this->getKpiService()->getKpiById($entityValue)->getKpiIndicators();
    }

    /**
     * @return \KpiService|null
     */
    public function getKpiService(): ?\KpiService
    {
        if (!$this->kpiService instanceof \KpiService) {
