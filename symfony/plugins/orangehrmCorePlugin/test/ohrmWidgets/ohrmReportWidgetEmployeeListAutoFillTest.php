 ...
 * @group ohrmWidget
 */
class ohrmReportWidgetEmployeeListAutoFillTest extends PHPUnit\Framework\TestCase
{
    /**
     * @var ohrmReportWidgetEmployeeListAutoFill
     */
    private $ohrmReportWidgetEmployeeListAutoFill = null;

    protected function setUp(): void
    {
        $this->ohrmReportWidgetEmployeeListAutoFill = $this->getMockBuilder(ohrmReportWidgetEmployeeListAutoFill::class)
