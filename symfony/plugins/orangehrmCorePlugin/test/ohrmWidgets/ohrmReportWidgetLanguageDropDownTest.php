 ...
 * @group ohrmWidget
 */
class ohrmReportWidgetLanguageDropDownTest extends PHPUnit\Framework\TestCase
{
    /**
     * @var ohrmReportWidgetLanguageDropDown
     */
    private $ohrmReportWidgetLanguageDropDown = null;

    protected function setUp(): void
    {
        $this->ohrmReportWidgetLanguageDropDown = $this->getMockBuilder(ohrmReportWidgetLanguageDropDown::class)
