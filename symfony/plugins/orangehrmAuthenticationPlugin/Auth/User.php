...
class User
{
    ...
    public const ADMIN_ACCESS_FORWARD_URL = 'admin_access_forward_url';
    public const ADMIN_ACCESS_BACK_URL = 'admin_access_back_url';
    ...
    public const FLASH_VERIFY_ERROR = 'flash.verify_error';
