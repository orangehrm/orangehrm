...
CREATE TABLE `ohrm_marketplace_addon` (`addon_id` INT(11), `title` VARCHAR(100), `date` TIMESTAMP, `status` VARCHAR(30), `version` VARCHAR(30), `plugin_name` VARCHAR(50), PRIMARY KEY(`addon_id`)) engine=innodb default charset=utf8;
