...
/**
 * Description of OpenIdentityService
 *
 * @author orangehrm
 */
class OpenIdentityService extends BaseOpenIdService{
    protected $openIdentityDao;
    ...
    public function getOpenIdentity($userId,$providerId){
         return $this->getOpenIdentityDao()->getOpenIdentity($userId, $providerId);
    }
    public function setOpenIdentity(UserIdentitiy $userIdentitiy){
         return $this->getOpenIdentityDao()->setOpenIdentity($userIdentitiy);
    }
}
