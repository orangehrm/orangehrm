                ...
                <?php if ($postShareCount > 0) { ?>
                    <a href="javascript:void(0)" class="postShare tiptip" title="<?php echo __('Share')?>" id=<?php echo 'postShareyes_' . $postId ?>> 
                        <img  src="<?php echo plugin_web_path("orangehrmBuzzPlugin", "images/like/share2.png"); ?>" 
                              border="0" id='<?php echo 'postLike_' . $postId ?>'height="30" width="30"/></a>
                    <a style="display:none;" href="javascript:void(0)" class="postShareOnOriginalPostPopup tiptip" title="<?php echo __('Share')?>" id=<?php echo 'postShareno_' . $postId ?>> 
    ...
    <div class="modal-body originalPostModal-body" >
        ...
        <div class="sharePageForm">
            ...
            <div id="sharedPostBody">
                ...
                <input type="button" class="btnShareOnPreview" name="btnSaveDependent" id='<?php echo 'btnShare_' . $postId . "_" . $originalPostId ?>' value="<?php echo __attr("Share"); ?>" />
...
<div id="photoPageComment" >
    ...
    <?php include_component('buzz', 'commentPreview', array('commentList' => $commentList, 'editForm' => $editForm, 'loggedInUser' => $loggedInUser, 'postId' => $postId, 'commentForm' => $commentForm, 'commentBoxId' => 'popPostId')); ?>
