...
class PerformanceReviewAPI extends EndPoint
{
     ...
     */
    public function getPerformanceReviewDetails()
    {
        $responseArray = null;
        $parameters = array();
        $parameters['employeeNumber'] = $this->getRequestParams()->getUrlParam(self::PARAMETER_ID);
        $reviews = $this->getPerformanceReviewService()->searchReview($parameters);
        return new Response($reviews->toArray(), array());
    }
}
