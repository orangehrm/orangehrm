...
{
    public const ALLOWED_SORT_FIELDS = ['es.yearsOfExp'];

    /**
     * @var float|null
     */
    protected ?float $yearsOfExp = null;
    ...
    /**
     * @param string|null $yearsOfExp
     */
    public function setYearsOfExp(?string $yearsOfExp): void
    {
