...
class EducationTest extends EntityTestCase
{
    ...
    public function testEducationEntity(): void
    {
        $education = new Education();
        $education->setName('Phd');
        $this->persist($education);

        /** @var Education $education */
        $education = $this->getRepository(Education::class)->find(1);
