...
describe('Add Skill', function () {
  it('check adding a skill', () => {
    ...
    cy.xpath(
      '//*[@id="app"]/div[1]/div/div[2]/div/div/form/div[1]/div/div[2]/input',
    ).type('skill1');
    cy.xpath(
      '//*[@id="app"]/div[1]/div/div[2]/div/div/form/div[2]/div/div[2]/textarea',
    ).type('Add description here2');
    cy.get('form').submit();
...
describe('Edit Skill', function () {
  it('check edit a skill', () => {
    ...
    cy.visit('/admin/viewSkills');
    cy.xpath(
      '//body[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[1]/div[2]/div[1]/div[1]/div[4]/div[1]/button[2]/i[1]',
    ).click();
    cy.xpath(
      '//*[@id="app"]/div[1]/div/div[2]/div/div/form/div[1]/div/div[2]/input',
    ).type('edit neww');
...
describe('Delete Skill', function () {
  it('check delete a skill', () => {
    ...
    cy.visit('/admin/viewSkills');
    cy.xpath(
      '//*[@id="app"]/div[1]/div/div[2]/div/div/div[3]/div/div[2]/div[1]/div/div[4]/div/button[1]/i',
    ).click();
...
describe('Maximum allowed charachters validation in Skill', function () {
  it('Check Maximum allowed charachters validation in Skill', () => {
    ...
    cy.xpath(
      '//*[@id="app"]/div[1]/div/div[2]/div/div/form/div[1]/div/div[2]/input',
    ).type('01234567890123456789012345678901234567890123456789');
    cy.get('.oxd-input-group__message').should(
      'include.text',
