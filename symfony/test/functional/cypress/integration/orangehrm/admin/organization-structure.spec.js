...
describe('Organization - Structure test script', function () {
  ...
  describe('UI testing- when toggle disabled', function () {
    it('Bin icon-invisible', () => {
      cy.get('.org-action > :nth-child(1)').should(
        'not.exist',
      );
    });
    it('+ icon-invisible', () => {
      cy.get('.org-action > :nth-child(3)').should(
        'not.exist',
      );
    });
    it('Edit icon-invisible', () => {
      cy.get('.org-action > :nth-child(2)').should(
        'not.exist',
      );
    });
    it('Open the view modal when double clicked', () => {
      cy.get('.oxd-sheet').dblclick();
      cy.get('.oxd-dialog-container-default--inner > .oxd-sheet').should('include.text', 'View Details');
    });
  });
  ...
  describe('Add Unit/Department testing', function () {
    it('Add Department', () => {
      ...
      cy.get(':nth-child(1) > .oxd-input-group > :nth-child(2) > .oxd-input').type(" ");
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').type("test1");
      cy.get('.oxd-form-actions > .oxd-button--secondary').click();
      cy.get('.oxd-toast').should(
        'include.text',
        'Successfully Saved',
      );
      cy.visit('/admin/viewCompanyStructure');
    ...
    it('Add Sub Department', () => {
      ...
      cy.get(':nth-child(1) > .oxd-input-group > :nth-child(2) > .oxd-input').type(" ");
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').type("SUBtest1");
      cy.get('.oxd-form-actions > .oxd-button--secondary').click();
      cy.get('.oxd-toast').should(
        'include.text',
        'Successfully Saved',
  ...
  describe('Text field validation testing-Name', function () {
    ...
    it('maximum length validation', () => {
      ...
      cy.get('.oxd-button').click();
      cy.get(':nth-child(1) > .oxd-input-group > :nth-child(2) > .oxd-input').type(" ");
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').type(charLength.chars100.text);
  ...
  describe('Text field validation testing-Id', function () {
    it('Input combination characters validation', () => {
      cy.get('.oxd-switch-input').click();
      cy.get('.oxd-button').click();
      cy.get(':nth-child(1) > .oxd-input-group > :nth-child(2) > .oxd-input').type("asd123!@#$");
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').type("test1");
      cy.get('.oxd-form-actions > .oxd-button--secondary').click();
      cy.get('.oxd-toast').should(
        'include.text',
    ...
    it('maximum length validation', () => {
      cy.get('.oxd-switch-input').click();
      cy.get('.oxd-button').click();
      cy.get(':nth-child(1) > .oxd-input-group > :nth-child(2) > .oxd-input').type(charLength.chars100.text);
      cy.get('.oxd-input-group > .oxd-text').should(
        'include.text',
        'Should be less than 100 characters',
      );
