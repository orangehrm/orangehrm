...
describe('Job - PayGrade test script', function () {
  ...
  describe('Add paygrade and Duplicate record validations testing', function () {
    ...
    after(() => {
      cy.visit('/admin/viewPayGrades');
      cy.get('.oxd-table-body > :nth-child(1) > .oxd-table-row > :nth-child(1) > .oxd-checkbox-wrapper > label > .oxd-checkbox-input > .oxd-icon').click();
  ...
  describe('Update paygrade testing', function () {
    it('update an existing paygrade and check toast message', () => {
      ...
      cy.get('.oxd-button--secondary').click();
      cy.visit('/admin/viewPayGrades');
      cy.get(':nth-child(1) > .oxd-table-row > [style="flex-shrink: 1;"] > .oxd-table-cell-actions > :nth-child(2) > .oxd-icon').click();
  ...
  describe('Cancel button testing', function () {
    it('add a paygrade, currency and clicking cancel', () => {
      ...
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2) > div > div').click();
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2)').contains('AED - Utd. Arab Emir. Dirham').click();
      cy.get(':nth-child(2) > .oxd-form > .oxd-form-actions > .oxd-button--ghost').click();
      cy.get(':nth-child(1) > .orangehrm-card-container > .oxd-text--h6').should('include.text', 'Edit Pay Grade');
    });
    it('Edit paygrade & clicking cancel', () => {
      cy.visit('/admin/viewPayGrades');
      cy.get(':nth-child(1) > .oxd-table-row > [style="flex-shrink: 1;"] > .oxd-table-cell-actions > :nth-child(2) > .oxd-icon').click();
      cy.get('.oxd-button--ghost').click();
      cy.get('.orangehrm-header-container > .oxd-text').should('include.text', 'Pay Grades');
    });
  ...
  describe('Deleting paygrade testing', function () {
    it('deleting a paygrade,check confirmation message and toast', () => {
      ...
      cy.get('.orangehrm-modal-header > .oxd-text').should('include.text', 
      'Are you Sure?'
      );
  ...
  describe('Add currency type, min/max salaray amount testing', function () {
    ...
    it('add a a paygrade,currency & one salary value', () => {
      ...
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2) > div > div').click();
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2)').contains('AED - Utd. Arab Emir. Dirham').click();
      cy.get('.oxd-grid-2 > :nth-child(1) > .oxd-input-group > :nth-child(2) > .oxd-input').type("200")
      cy.get(':nth-child(2) > .oxd-form > .oxd-form-actions > .oxd-button--secondary').click();
      cy.get('.oxd-table-card > .oxd-table-row > :nth-child(3)').should('include.text', '200');
      cy.get('.oxd-toast').should('include.text', 'Successfully Saved');
    });
    after(() => {
      cy.visit('/admin/viewPayGrades');
      cy.get('.oxd-table-body > :nth-child(1) > .oxd-table-row > :nth-child(1) > .oxd-checkbox-wrapper > label > .oxd-checkbox-input > .oxd-icon').click();
      cy.get(':nth-child(2) > .oxd-table-row > :nth-child(1) > .oxd-checkbox-wrapper > label > .oxd-checkbox-input > .oxd-icon').click();
      cy.get('.orangehrm-horizontal-padding > div > .oxd-button').click();
      cy.get('.orangehrm-modal-footer > .oxd-button--label-danger').click();
    });
  });
  ...
  describe('Validation- currency type, min/max salary amount', function () {
    ...
    it('amount field length validation', () => {
      ...
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2) > div > div').click();
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2)').contains('AED - Utd. Arab Emir. Dirham').click();
      cy.get('.oxd-grid-2 > :nth-child(1) > .oxd-input-group > :nth-child(2) > .oxd-input').type(charLength.chars10.int);
      cy.get('.oxd-input-group > .oxd-text').should('include.text', 'Should be less than 1000,000,000');
    });
    it('add currency with max value smaller than min value validation', () => {
      ...
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2) > div > div').click();
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2)').contains('AED - Utd. Arab Emir. Dirham').click();
      cy.get('.oxd-grid-2 > :nth-child(1) > .oxd-input-group > :nth-child(2) > .oxd-input'
      ).clear().type("600");
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').clear().type('300');
      cy.get(':nth-child(2) > .oxd-input-group > .oxd-text').should('include.text', 'Should be higher than Minimum Salary');
    });
    it('amount field character validation', () => {
      ...
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2) > div > div').click();
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2)').contains('AED - Utd. Arab Emir. Dirham').click();
      cy.get('.oxd-grid-2 > :nth-child(1) > .oxd-input-group > :nth-child(2) > .oxd-input').type("asd@#");
      cy.get('.oxd-input-group > .oxd-text').should('include.text', 'Should be a number');
    });
    after(() => {
      cy.visit('/admin/viewPayGrades');
      cy.get('.oxd-table-body > :nth-child(1) > .oxd-table-row > :nth-child(1) > .oxd-checkbox-wrapper > label > .oxd-checkbox-input > .oxd-icon').click();
      cy.get(':nth-child(2) > .oxd-table-row > :nth-child(1) > .oxd-checkbox-wrapper > label > .oxd-checkbox-input > .oxd-icon').click();
      cy.get(':nth-child(3) > .oxd-table-row > :nth-child(1) > .oxd-checkbox-wrapper > label > .oxd-checkbox-input > .oxd-icon').click();
      cy.get(':nth-child(4) > .oxd-table-row > :nth-child(1) > .oxd-checkbox-wrapper > label > .oxd-checkbox-input > .oxd-icon').click();
      cy.get('.orangehrm-horizontal-padding > div > .oxd-button').click();
      cy.get('.orangehrm-modal-footer > .oxd-button--label-danger').click();
    });
  });
  ...
  describe('Edit currency type, min/max salaray amount testing', function () {
    it('Edit currency details', () => {
      ...
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').type('1000');
      cy.get(':nth-child(2) > .oxd-form > .oxd-form-actions > .oxd-button--secondary').click();
      cy.visit('/admin/viewPayGrades');
      ...
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').clear().type('900');
      cy.get(':nth-child(2) > .oxd-form > .oxd-form-actions > .oxd-button--secondary').click();
    ...
    it('Edit Currency Type', () => {
      cy.get(':nth-child(1) > .oxd-table-row > [style="flex-shrink: 1;"] > .oxd-table-cell-actions > :nth-child(2)').click();
      cy.get('.oxd-table-cell-actions > :nth-child(2)').click();
      cy.get('#app > div.oxd-layout > div > div.oxd-layout-context > div.orangehrm-card-container > form > div:nth-child(1) > div > div > div > div:nth-child(2) > input').should('be.disabled');
    });
    it('Edit Amount where max salary = min salary', () => {
      ...
      cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-input').clear().type('400');
      cy.get(':nth-child(2) > .oxd-form > .oxd-form-actions > .oxd-button--secondary').click();
      cy.get('.oxd-toast').should('include.text', 'Successfully Updated');
    });
  });
  ...
  describe('Delete currency type', function () {
    it('Delete a single currency and confirmation message', () => {
      ...
      cy.get('.orangehrm-modal-header > .oxd-text').should('include.text', 'Are you Sure?');
      cy.get('.oxd-button--label-danger').click();
      cy.get('.oxd-toast').should('include.text', 'Successfully Deleted');
      cy.visit('/admin/viewPayGrades');
      cy.get('.oxd-table-body > :nth-child(1) > .oxd-table-row > :nth-child(1) > .oxd-checkbox-wrapper > label > .oxd-checkbox-input > .oxd-icon').click();
    ...
    it('Bulk delete currency', () => {
      ...
      cy.visit('/admin/viewPayGrades');
      cy.get(':nth-child(1) > .oxd-table-row > [style="flex-shrink: 1;"] > .oxd-table-cell-actions > :nth-child(2)').click();
      cy.get('.oxd-table-card > .oxd-table-row > :nth-child(1) > .oxd-checkbox-wrapper > label > .oxd-checkbox-input > .oxd-icon').click();
      cy.get('.orangehrm-horizontal-padding > div > .oxd-button').click();
      cy.get('.orangehrm-modal-footer > .oxd-button--label-danger').click();
      cy.get('.oxd-toast').should('include.text', 'Successfully Deleted');
    });
