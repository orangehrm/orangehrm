...
use SchemaIncrementTask;

/**
 * Class SchemaIncrementTask79
 */
class SchemaIncrementTask79 extends SchemaIncrementTask
{

    public function loadSql()
    {
        $sql[] = "UPDATE `hs_hr_config` SET `value` = '4.7' WHERE `hs_hr_config`.`key` = 'instance.version';";
