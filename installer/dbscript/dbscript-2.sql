...
VALUES ('apiv2_attendance_configuration', 'API-v2 Attendance - Attendance Configuration', 1, 0, 1, 0),
       ('apiv2_employee_attendance_record', 'API-v2 Attendance - Employee Attendance', 1, 0, 0, 0);
...
SET @apiv2_employee_attendance_record_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_employee_attendance_record' LIMIT 1);
...
VALUES ('OrangeHRM\\Attendance\\Api\\AttendanceConfigurationAPI', @attendance_module_id, @apiv2_attendance_configuration_data_group_id),
       ('OrangeHRM\\Attendance\\Api\\EmployeeAttendanceAPI', @attendance_module_id, @apiv2_employee_attendance_data_group_id);

INSERT INTO ohrm_user_role_data_group (`can_read`, `can_create`, `can_update`, `can_delete`, `self`, `data_group_id`, `user_role_id`)
VALUES (1, 0, 1, 0, 0, @apiv2_attendance_configuration_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @apiv2_employee_attendance_record_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @apiv2_employee_attendance_record_data_group_id, @ess_role_id);
