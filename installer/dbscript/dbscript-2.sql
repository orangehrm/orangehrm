...
VALUES ('personal_sensitive_information', 'PIM - PIM - Personal Details - Sensitive', 1, 0, 1, 0),
       ...
       ('apiv2_about_organization', 'API-v2 Core', 1, 0, 0, 0);
...
SET @apiv2_about_organization_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_about_organization' LIMIT 1);
...
VALUES ('OrangeHRM\\Core\\Api\\Rest\\DataGroupAPI', @core_module_id, @apiv2_core_data_groups_data_group_id),
       ('OrangeHRM\\Core\\Api\\Rest\\AboutOrganizationAPI', @core_module_id, @apiv2_about_organization_data_group_id);
...
VALUES (1, 0, 1, 0, 0, @personal_sensitive_information_data_group_id, @admin_role_id),
       ...
       (1, 0, 0, 0, 0, @apiv2_about_organization_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @apiv2_about_organization_data_group_id, @ess_role_id),
       (1, 0, 0, 0, 0, @apiv2_about_organization_data_group_id, @supervisor_role_id);
