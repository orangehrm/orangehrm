...
SET `status` = '0'
WHERE `ohrm_menu_item`.`menu_title` = 'Pay Grades';
UPDATE `ohrm_menu_item`
SET `status` = '0'
WHERE `ohrm_menu_item`.`menu_title` = 'Work Shifts';
UPDATE `ohrm_menu_item`
SET `status` = '0'
...
SET
@apiv2_leave_leave_requests_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_leave_requests' LIMIT 1);
SET
...
SET
@apiv2_customers_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_customers' LIMIT 1);
