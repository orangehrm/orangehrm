...
UPDATE `ohrm_module`
SET `status` = '0'
WHERE `ohrm_module`.`name` = 'time';
UPDATE `ohrm_module`
SET `status` = '0'
WHERE `ohrm_module`.`name` = 'attendance';
UPDATE `ohrm_module`
SET `status` = '0'
WHERE `ohrm_module`.`name` = 'recruitment';
UPDATE `ohrm_module`
SET `status` = '0'
WHERE `ohrm_module`.`name` = 'recruitmentApply';
UPDATE `ohrm_module`
SET `status` = '0'
WHERE `ohrm_module`.`name` = 'dashboard';
UPDATE `ohrm_module`
SET `status` = '0'
WHERE `ohrm_module`.`name` = 'performance';
UPDATE `ohrm_module`
SET `status` = '0'
WHERE `ohrm_module`.`name` = 'directory';
UPDATE `ohrm_module`
SET `status` = '0'
WHERE `ohrm_module`.`name` = 'maintenance';
UPDATE `ohrm_module`
SET `status` = '0'
WHERE `ohrm_module`.`name` = 'marketPlace';
UPDATE `ohrm_module`
SET `status` = '0'
WHERE `ohrm_module`.`name` = 'buzz';
UPDATE `ohrm_menu_item`
SET `status` = '0'
WHERE `ohrm_menu_item`.`menu_title` = 'Email Subscriptions';
UPDATE `ohrm_menu_item`
SET `status` = '0'
WHERE `ohrm_menu_item`.`menu_title` = 'Localization';
UPDATE `ohrm_menu_item`
SET `status` = '0'
WHERE `ohrm_menu_item`.`menu_title` = 'Language Packages';
UPDATE `ohrm_menu_item`
SET `status` = '0'
WHERE `ohrm_menu_item`.`menu_title` = 'Modules';
UPDATE `ohrm_menu_item`
SET `status` = '0'
WHERE `ohrm_menu_item`.`menu_title` = 'Social Media Authentication';

UPDATE `ohrm_menu_item`
SET `status` = '0'
WHERE `ohrm_menu_item`.`menu_title` = 'Reports'
  AND `screen_id` IS NOT NULL;
UPDATE `ohrm_menu_item`
SET `status` = '0'
WHERE `ohrm_menu_item`.`menu_title` = 'Data Import';

UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"icon-admin\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Admin';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"icon-pim\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'PIM';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"icon-time\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Time';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"icon-leave\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Leave';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"icon-recruitment\"}'
