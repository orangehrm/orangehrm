...
VALUES ('apiv2_time_time_sheet_config', 'API-v2 Time - Time Sheet Start Day Configuration', 1, 0, 1, 0),
       ...
       ('time_report_project_report', 'Time - Project report', 1, 0, 0, 0);
...
VALUES (1, 0, 1, 0, 0, @apiv2_time_time_sheet_config_data_group_id, @admin_role_id),
       ...
       (1, 0, 0, 0, 0, @time_report_project_report_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @time_report_project_report_data_group_id, @project_admin_role_id);
