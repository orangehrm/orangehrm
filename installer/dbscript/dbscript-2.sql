...
VALUES ('apiv2_admin_education', 'API-v2 Admin - Education', 1, 1, 1, 1),
       ...
       ('apiv2_validation_user_name', 'Admin-v2 Admin - User Name Validation', 1, 0, 0, 0);
...
SET @apiv2_email_subscriptions_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_email_subscriptions' LIMIT 1);
SET @apiv2_email_subscribers_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_email_subscribers' LIMIT 1);
SET @apiv2_validation_user_name_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_validation_user_name' LIMIT 1);
...
VALUES ('OrangeHRM\\Admin\\Api\\EducationAPI', @admin_module_id, @apiv2_admin_education_data_group_id),
       ...
       ('OrangeHRM\\Admin\\Api\\EmailSubscriptionAPI', @admin_module_id, @apiv2_email_subscriptions_data_group_id),
       ('OrangeHRM\\Admin\\Api\\EmailSubscriberAPI', @admin_module_id, @apiv2_email_subscribers_data_group_id),
       ('OrangeHRM\\Admin\\Api\\ValidationUserNameAPI', @admin_module_id, @apiv2_validation_user_name_data_group_id);
...
VALUES (1, 1, 1, 1, 0, @apiv2_admin_education_data_group_id, @admin_role_id),
       ...
       (1, 0, 0, 0, 0, @apiv2_admin_work_shift_employee_data_group_id, @admin_role_id),
       (1, 0, 1, 0, 0, @apiv2_email_subscriptions_data_group_id, @admin_role_id),
       (1, 1, 1, 1, 0, @apiv2_email_subscribers_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @apiv2_validation_user_name_data_group_id, @admin_role_id);
...
VALUES ('apiv2_pim_custom_field', 'API-v2 PIM - Custom Fields', 1, 1, 1, 1),
       ...
       ('apiv2_validation_work_email', 'API-v2 PIM - Work Email Validation', 1, 0, 0, 0);
...
SET @apiv2_validation_work_email_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_validation_work_email' LIMIT 1);
...
VALUES ('OrangeHRM\\Pim\\Api\\CustomFieldAPI', @pim_module_id, @apiv2_pim_custom_field_data_group_id),
       ...
       ('OrangeHRM\\Pim\\Api\\ValidationEmployeeEmailAPI', @pim_module_id, @apiv2_validation_work_email_data_group_id);
...
VALUES (1, 1, 1, 1, 0, @apiv2_pim_custom_field_data_group_id, @admin_role_id),
       ...
       (1, 0, 0, 0, 1, @apiv2_validation_work_email_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 1, @apiv2_validation_work_email_data_group_id, @ess_role_id);
