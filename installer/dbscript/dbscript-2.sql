...
VALUES ('apiv2_time_time_sheet_config', 'API-v2 Time - Time Sheet Start Day Configuration', 1, 0, 1, 0),
       ...
       ('apiv2_time_employee_timesheet_action', 'API-v2 Time - Employee Timesheets action', 1, 0, 0, 0);
...
SET @apiv2_time_employee_timesheet_action_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_employee_timesheet_action' LIMIT 1);
...
VALUES ('OrangeHRM\\Time\\Api\\TimeConfigPeriodAPI', @time_module_id, @apiv2_time_time_sheet_config_data_group_id),
       ...
       ('OrangeHRM\\Time\\Api\\EmployeeTimesheetActionAPI', @time_module_id, @apiv2_time_employee_timesheet_action_data_group_id);
...
VALUES (1, 0, 1, 0, 0, @apiv2_time_time_sheet_config_data_group_id, @admin_role_id),
       ...
       (1, 0, 0, 0, 0, @apiv2_time_employee_timesheet_action_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @apiv2_time_employee_timesheet_action_data_group_id, @supervisor_role_id);
