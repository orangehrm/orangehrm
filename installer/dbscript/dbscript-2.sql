...
VALUES ('apiv2_pim_custom_field', 'API-v2 PIM - Custom Fields', 1, 1, 1, 1),
       ...
       ('apiv2_tax_exemption', 'API-v2 Pim - Tax Exemption', 1, 0, 1, 0);
...
SET @apiv2_tax_exemption_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_tax_exemption' LIMIT 1);
...
VALUES ('OrangeHRM\\Pim\\Api\\CustomFieldAPI', @pim_module_id, @apiv2_pim_custom_field_data_group_id),
       ...
       ('OrangeHRM\\Pim\\Api\\EmpUsTaxExemptionAPI', @pim_module_id, @apiv2_tax_exemption_data_group_id);
...
VALUES (1, 1, 1, 1, 0, @apiv2_pim_custom_field_data_group_id, @admin_role_id),
       ...
       (1, 0, 1, 0, 0, @apiv2_tax_exemption_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 1, @apiv2_tax_exemption_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 1, @apiv2_tax_exemption_data_group_id, @ess_role_id),
       (1, 0, 0, 0, 0, @apiv2_tax_exemption_data_group_id, @ess_role_id);
