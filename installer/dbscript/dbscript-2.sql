...
SET @apiv2_attendance_summary_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'attendance_summary' LIMIT 1);
...
VALUES (1, 0, 1, 0, 0, @apiv2_attendance_configuration_data_group_id, @admin_role_id),
       ...
       (1, 0, 0, 0, 1, @apiv2_attendance_summary_data_group_id, @admin_role_id);
