...
INSERT INTO `hs_hr_currency_type`(`code`, `currency_id`, `currency_name`)
VALUES (3, 'AED', 'Utd. Arab Emir. Dirham'),
...
INSERT INTO `hs_hr_province`(`id`, `province_name`, `province_code`, `cou_code`)
VALUES (1, 'Alaska', 'AK', 'US'),
       (2, 'Alabama', 'AL', 'US'),
...
INSERT INTO `hs_hr_module`
VALUES ('MOD001', 'Admin', 'OrangeHRM', 'info@orangehrm.com', 'VER001', 'HR Admin'),
...
VALUES (1, NULL, 0, 0, 0, 0, 0, 8, 8);

INSERT INTO `hs_hr_payperiod`(payperiod_code, payperiod_name)
VALUES (1, 'Weekly'),
       (2, 'Bi Weekly'),
       (3, 'Semi Monthly'),
       (4, 'Monthly'),
...
INSERT INTO `hs_hr_config`(`key`, `value`)
VALUES ('ldap_server', ''),
       ('ldap_domain_name', ''),
       ('ldap_port', ''),
       ('ldap_status', ''),
       ...
       ('timesheet_period_and_start_date',
        '<TimesheetPeriod><PeriodType>Weekly</PeriodType><ClassName>WeeklyTimesheetPeriod</ClassName><StartDate>1</StartDate><Heading>Week</Heading></TimesheetPeriod>'),
...
INSERT INTO `ohrm_emp_reporting_method`(`reporting_method_id`, `reporting_method_name`)
VALUES (1, 'Direct'),
       (2, 'Indirect');


INSERT INTO `hs_hr_unique_id`(last_id, table_name, field_name)
VALUES (0, 'hs_hr_employee', 'emp_number'),
...
INSERT INTO `ohrm_report` (`report_id`, `name`, `report_group_id`, `use_filter_field`, `type`)
VALUES (1, 'Project Report', 1, 1, null),
...
INSERT INTO `ohrm_filter_field` (`filter_field_id`, `report_group_id`, `name`, `where_clause_part`,
                                 `filter_field_widget`, `condition_no`, `required`)
VALUES (1, 1, 'project_name', 'ohrm_project.project_id', 'ohrmWidgetProjectList', 2, 'true'),
       ...
       (7, 1, 'only_include_approved_timesheets', 'ohrm_timesheet.state', 'ohrmWidgetApprovedTimesheetInputCheckBox', 2,
        null),
       ...
       (12, 3, 'service_period', 'datediff(current_date(), hs_hr_employee.joined_date)/365',
        'ohrmReportWidgetServicePeriod', 1, null),
       ...
       (17, 3, 'age_group', 'datediff(current_date(), hs_hr_employee.emp_birthday)/365', 'ohrmReportWidgetAgeGroup', 1,
        null),
...
INSERT INTO `ohrm_display_field_group`(`id`, `report_group_id`, `name`, `is_list`)
VALUES (1, 3, 'Personal', false),
...
INSERT INTO `ohrm_display_field` (`display_field_id`, `report_group_id`, `name`, `label`, `field_alias`, `is_sortable`,
                                  `sort_order`, `sort_field`, `element_type`, `element_property`, `width`,
                                  `is_exportable`, `text_alignment_style`, `is_value_list`, `display_field_group_id`,
                                  `default_value`, `is_encrypted`, `is_meta`)
VALUES (1, 1, 'ohrm_project.name', 'Project Name', 'projectname', 'false', null, null, 'label',
        '<xml><getter>projectname</getter></xml>', 200, '0', null, false, null, null, false, false),
       (2, 1, 'ohrm_project_activity.name', 'Activity Name', 'activityname', 'false', null, null, 'link',
        '<xml><labelGetter>activityname</labelGetter><placeholderGetters><id>activity_id</id><total>totalduration</total><projectId>projectId</projectId><from>fromDate</from><to>toDate</to><approved>onlyIncludeApprovedTimesheets</approved></placeholderGetters><urlPattern>../../displayProjectActivityDetailsReport?reportId=3#activityId={id}#total={total}#from={from}#to={to}#projectId={projectId}#onlyIncludeApprovedTimesheets={approved}</urlPattern></xml>',
        200, '0', null, false, null, null, false, false),
       (3, 1, 'ohrm_project_activity.project_id', 'Project Id', null, 'false', null, null, 'label',
        '<xml><getter>project_id</getter></xml>', 75, '0', 'right', false, null, null, false, true),
       (4, 1, 'ohrm_project_activity.activity_id', 'Activity Id', null, 'false', null, null, 'label',
        '<xml><getter>activity_id</getter></xml>', 75, '0', 'right', false, null, null, false, true),
       (5, 1, 'ohrm_timesheet_item.duration', 'Time (hours)', null, 'false', null, null, 'label',
        '<xml><getter>duration</getter></xml>', 75, '0', 'right', false, null, null, false, false),
       (6, 1, 'hs_hr_employee.emp_firstname', 'Employee First Name', null, 'false', null, null, 'label',
        '<xml><getter>emp_firstname</getter></xml>', 200, '0', null, false, null, null, false, false),
       (7, 1, 'hs_hr_employee.emp_lastname', 'Employee Last Name', null, 'false', null, null, 'label',
        '<xml><getter>emp_lastname</getter></xml>', 200, '0', null, false, null, null, false, false),
       (8, 1, 'ohrm_project_activity.name', 'Activity Name', 'activityname', 'false', null, null, 'label',
        '<xml><getter>activityname</getter></xml>', 200, '0', null, false, null, null, false, false),
       (9, 3, 'hs_hr_employee.employee_id', 'Employee Id', 'employeeId', 'false', null, null, 'label',
        '<xml><getter>employeeId</getter></xml>', 100, '0', null, false, 1, '---', false, false),
       (10, 3, 'hs_hr_employee.emp_lastname', 'Employee Last Name', 'employeeLastname', 'false', null, null, 'label',
        '<xml><getter>employeeLastname</getter></xml>', 200, '0', null, false, 1, '---', false, false),
       (11, 3, 'hs_hr_employee.emp_firstname', 'Employee First Name', 'employeeFirstname', 'false', null, null, 'label',
        '<xml><getter>employeeFirstname</getter></xml>', 200, '0', null, false, 1, '---', false, false),
       (12, 3, 'hs_hr_employee.emp_middle_name', 'Employee Middle Name', 'employeeMiddlename', 'false', null, null,
        'label', '<xml><getter>employeeMiddlename</getter></xml>', 200, '0', null, false, 1, '---', false, false),
       (13, 3, 'hs_hr_employee.emp_birthday', 'Date of Birth', 'empBirthday', 'false', null, null, 'labelDate',
        '<xml><getter>empBirthday</getter></xml>', 100, '0', null, false, 1, '---', false, false),
       (14, 3, 'ohrm_nationality.name', 'Nationality', 'nationality', 'false', null, null, 'label',
        '<xml><getter>nationality</getter></xml>', 200, '0', null, false, 1, '---', false, false),
       (15, 3, 'CASE hs_hr_employee.emp_gender WHEN 1 THEN "Male" WHEN 2 THEN "Female" WHEN 3 THEN "Other" END',
        'Gender', 'empGender', 'false', null, null, 'label', '<xml><getter>empGender</getter></xml>', 80, '0', null,
        false, 1, '---', false, false),
       (17, 3, 'hs_hr_employee.emp_marital_status', 'Marital Status', 'maritalStatus', 'false', null, null, 'label',
        '<xml><getter>maritalStatus</getter></xml>', 100, '0', null, false, 1, '---', false, false),
       (18, 3, 'hs_hr_employee.emp_dri_lice_num', 'Driver License Number', 'driversLicenseNumber', 'false', null, null,
        'label', '<xml><getter>driversLicenseNumber</getter></xml>', 240, '0', null, false, 1, '---', false, false),
       (19, 3, 'hs_hr_employee.emp_dri_lice_exp_date', 'License Expiry Date', 'licenseExpiryDate', 'false', null, null,
        'labelDate', '<xml><getter>licenseExpiryDate</getter></xml>', 135, '0', null, false, 1, '---', false, false),
       (20, 3,
        'CONCAT_WS(", ", NULLIF(hs_hr_employee.emp_street1, ""), NULLIF(hs_hr_employee.emp_street2, ""), NULLIF(hs_hr_employee.city_code, ""), NULLIF(hs_hr_employee.provin_code,""), NULLIF(hs_hr_employee.emp_zipcode,""), NULLIF(hs_hr_country.cou_name,""))',
        'Address', 'address', 'false', null, null, 'label', '<xml><getter>address</getter></xml>', 200, '0', null,
        false, 2, '---', false, false),
       (21, 3, 'hs_hr_employee.emp_hm_telephone', 'Home Telephone', 'homeTelephone', 'false', null, null, 'label',
        '<xml><getter>homeTelephone</getter></xml>', 130, '0', null, false, 2, '---', false, false),
       (22, 3, 'hs_hr_employee.emp_mobile', 'Mobile', 'mobile', 'false', null, null, 'label',
        '<xml><getter>mobile</getter></xml>', 100, '0', null, false, 2, '---', false, false),
       (23, 3, 'hs_hr_employee.emp_work_telephone', 'Work Telephone', 'workTelephone', 'false', null, null, 'label',
        '<xml><getter>workTelephone</getter></xml>', 100, '0', null, false, 2, '---', false, false),
       (24, 3, 'hs_hr_employee.emp_work_email', 'Work Email', 'workEmail', 'false', null, null, 'label',
        '<xml><getter>workEmail</getter></xml>', 200, '0', null, false, 2, '---', false, false),
       (25, 3, 'hs_hr_employee.emp_oth_email', 'Other Email', 'otherEmail', 'false', null, null, 'label',
        '<xml><getter>otherEmail</getter></xml>', 200, '0', null, false, 2, '---', false, false),
       (26, 3, 'hs_hr_emp_emergency_contacts.eec_name', 'Name', 'ecname', 'false', null, null, 'label',
        '<xml><getter>ecname</getter></xml>', 200, '0', null, true, 3, '---', false, false),
       (27, 3, 'hs_hr_emp_emergency_contacts.eec_home_no', 'Home Telephone', 'ecHomeTelephone', 'false', null, null,
        'label', '<xml><getter>ecHomeTelephone</getter></xml>', 130, '0', null, true, 3, '---', false, false),
       (28, 3, 'hs_hr_emp_emergency_contacts.eec_office_no', 'Work Telephone', 'ecWorkTelephone', 'false', null, null,
        'label', '<xml><getter>ecWorkTelephone</getter></xml>', 100, '0', null, true, 3, '---', false, false),
       (29, 3, 'hs_hr_emp_emergency_contacts.eec_relationship', 'Relationship', 'ecRelationship', 'false', null, null,
        'label', '<xml><getter>ecRelationship</getter></xml>', 200, '0', null, true, 3, '---', false, false),
       (30, 3, 'hs_hr_emp_emergency_contacts.eec_mobile_no', 'Mobile', 'ecMobile', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 3, '---', false, false),
       (31, 3, 'hs_hr_emp_dependents.ed_name', 'Name', 'dependentName', 'false', null, null, 'label',
        '<xml><getter>dependentName</getter></xml>', 200, '0', null, true, 4, '---', false, false),
       (32, 3,
        'IF (hs_hr_emp_dependents.ed_relationship_type = \'other\', hs_hr_emp_dependents.ed_relationship, hs_hr_emp_dependents.ed_relationship_type)',
        'Relationship', 'dependentRelationship', 'false', null, null, 'label',
        '<xml><getter>dependentRelationship</getter></xml>', 200, '0', null, true, 4, '---', false, false),
       (33, 3, 'hs_hr_emp_dependents.ed_date_of_birth', 'Date of Birth', 'dependentDateofBirth', 'false', null, null,
        'labelDate', '<xml><getter>dependentDateofBirth</getter></xml>', 100, '0', null, true, 4, '---', false, false),
       (35, 3, 'ohrm_membership.name', 'Membership', 'name', 'false', null, null, 'label',
        '<xml><getter>name</getter></xml>', 200, '0', null, true, 15, '---', false, false),
       (36, 3, 'hs_hr_emp_member_detail.ememb_subscript_ownership', 'Subscription Paid By', 'subscriptionPaidBy',
        'false', null, null, 'label', '<xml><getter>subscriptionPaidBy</getter></xml>', 200, '0', null, true, 15, '---',
        false, false),
       (37, 3, 'hs_hr_emp_member_detail.ememb_subscript_amount', 'Subscription Amount', 'subscriptionAmount', 'false',
        null, null, 'label', '<xml><getter>subscriptionAmount</getter></xml>', 200, '0', null, true, 15, '---', false,
        false),
       (38, 3, 'hs_hr_emp_member_detail.ememb_subs_currency', 'Currency', 'membershipCurrency', 'false', null, null,
        'label', '<xml><getter>membershipCurrency</getter></xml>', 200, '0', null, true, 15, '---', false, false),
       (39, 3, 'hs_hr_emp_member_detail.ememb_commence_date', 'Subscription Commence Date', 'subscriptionCommenceDate',
        'false', null, null, 'labelDate', '<xml><getter>subscriptionCommenceDate</getter></xml>', 200, '0', null, true,
        15, '---', false, false),
       (40, 3, 'hs_hr_emp_member_detail.ememb_renewal_date', 'Subscription Renewal Date', 'subscriptionRenewalDate',
        'false', null, null, 'labelDate', '<xml><getter>subscriptionRenewalDate</getter></xml>', 200, '0', null, true,
        15, '---', false, false),
       (41, 3, 'hs_hr_emp_work_experience.eexp_employer', 'Company', 'expCompany', 'false', null, null, 'label',
        '<xml><getter>expCompany</getter></xml>', 200, '0', null, true, 10, '---', false, false),
       (42, 3, 'hs_hr_emp_work_experience.eexp_jobtit', 'Job Title', 'expJobTitle', 'false', null, null, 'label',
        '<xml><getter>expJobTitle</getter></xml>', 200, '0', null, true, 10, '---', false, false),
       (43, 3, 'hs_hr_emp_work_experience.eexp_from_date', 'From', 'expFrom', 'false', null, null, 'labelDate',
        '<xml><getter>expFrom</getter></xml>', 100, '0', null, true, 10, '---', false, false),
       (44, 3, 'hs_hr_emp_work_experience.eexp_to_date', 'To', 'expTo', 'false', null, null, 'labelDate',
        '<xml><getter>expTo</getter></xml>', 100, '0', null, true, 10, '---', false, false),
       (45, 3, 'hs_hr_emp_work_experience.eexp_comments', 'Comment', 'expComment', 'false', null, null, 'label',
        '<xml><getter>expComment</getter></xml>', 200, '0', null, true, 10, '---', false, false),
       (47, 3, 'ohrm_education.name', 'Level', 'eduProgram', 'false', null, null, 'label',
        '<xml><getter>eduProgram</getter></xml>', 200, '0', null, true, 11, '---', false, false),
       (48, 3, 'ohrm_emp_education.year', 'Year', 'eduYear', 'false', null, null, 'label',
        '<xml><getter>eduYear</getter></xml>', 100, '0', null, true, 11, '---', false, false),
       (49, 3, 'ohrm_emp_education.score', 'Score', 'eduGPAOrScore', 'false', null, null, 'label',
        '<xml><getter>eduGPAOrScore</getter></xml>', 80, '0', null, true, 11, '---', false, false),
       (52, 3, 'ohrm_skill.name', 'Skill', 'skill', 'false', null, null, 'label', '<xml><getter>skill</getter></xml>',
        200, '0', null, true, 12, '---', false, false),
       (53, 3, 'hs_hr_emp_skill.years_of_exp', 'Years of Experience', 'skillYearsOfExperience', 'false', null, null,
        'label', '<xml><getter>skillYearsOfExperience</getter></xml>', 135, '0', null, true, 12, '---', false, false),
       (54, 3, 'hs_hr_emp_skill.comments', 'Comments', 'skillComments', 'false', null, null, 'label',
        '<xml><getter>skillComments</getter></xml>', 200, '0', null, true, 12, '---', false, false),
       (55, 3, 'ohrm_language.name', 'Language', 'langName', 'false', null, null, 'label',
        '<xml><getter>langName</getter></xml>', 200, '0', null, true, 13, '---', false, false),
       (57, 3,
        'CASE hs_hr_emp_language.competency WHEN 1 THEN "Poor" WHEN 2 THEN "Basic" WHEN 3 THEN "Good" WHEN 4 THEN "Mother Tongue" END',
        'Competency', 'langCompetency', 'false', null, null, 'label', '<xml><getter>langCompetency</getter></xml>', 130,
        '0', null, true, 13, '---', false, false),
       (58, 3, 'hs_hr_emp_language.comments', 'Comments', 'langComments', 'false', null, null, 'label',
        '<xml><getter>langComments</getter></xml>', 200, '0', null, true, 13, '---', false, false),
       (59, 3, 'ohrm_license.name', 'License Type', 'empLicenseType', 'false', null, null, 'label',
        '<xml><getter>empLicenseType</getter></xml>', 200, '0', null, true, 14, '---', false, false),
       (60, 3, 'ohrm_emp_license.license_issued_date', 'Issued Date', 'empLicenseIssuedDate', 'false', null, null,
        'labelDate', '<xml><getter>empLicenseIssuedDate</getter></xml>', 100, '0', null, true, 14, '---', false, false),
       (61, 3, 'ohrm_emp_license.license_expiry_date', 'Expiry Date', 'empLicenseExpiryDate', 'false', null, null,
        'labelDate', '<xml><getter>empLicenseExpiryDate</getter></xml>', 100, '0', null, true, 14, '---', false, false),
       (62, 3, 'supervisor.emp_firstname', 'First Name', 'supervisorFirstName', 'false', null, null, 'label',
        '<xml><getter>supervisorFirstName</getter></xml>', 200, '0', null, true, 9, '---', false, false),
       (63, 3, 'subordinate.emp_firstname', 'First Name', 'subordinateFirstName', 'false', null, null, 'label',
        '<xml><getter>subordinateFirstName</getter></xml>', 200, '0', null, true, 8, '---', false, false),
       (64, 3, 'supervisor.emp_lastname', 'Last Name', 'supervisorLastName', 'false', null, null, 'label',
        '<xml><getter>supervisorLastName</getter></xml>', 200, '0', null, true, 9, '---', false, false),
       (65, 3, 'ohrm_pay_grade.name', 'Pay Grade', 'salPayGrade', 'false', null, null, 'label',
        '<xml><getter>salPayGrade</getter></xml>', 200, '0', null, true, 7, '---', false, false),
       (66, 3, 'hs_hr_emp_basicsalary.salary_component', 'Salary Component', 'salSalaryComponent', 'false', null, null,
        'label', '<xml><getter>salSalaryComponent</getter></xml>', 200, '0', null, true, 7, '---', false, false),
       (67, 3, 'hs_hr_emp_basicsalary.ebsal_basic_salary', 'Amount', 'salAmount', 'false', null, null, 'label',
        '<xml><getter>salAmount</getter></xml>', 200, '0', null, true, 7, '---', true, false),
       (68, 3, 'hs_hr_emp_basicsalary.comments', 'Comments', 'salComments', 'false', null, null, 'label',
        '<xml><getter>salComments</getter></xml>', 200, '0', null, true, 7, '---', false, false),
       (69, 3, 'hs_hr_payperiod.payperiod_name', 'Pay Frequency', 'salPayFrequency', 'false', null, null, 'label',
        '<xml><getter>salPayFrequency</getter></xml>', 200, '0', null, true, 7, '---', false, false),
       (70, 3, 'hs_hr_currency_type.currency_name', 'Currency', 'salCurrency', 'false', null, null, 'label',
        '<xml><getter>salCurrency</getter></xml>', 200, '0', null, true, 7, '---', false, false),
       (71, 3, 'hs_hr_emp_directdebit.dd_account', 'Direct Deposit Account Number', 'ddAccountNumber', 'false', null,
        null, 'label', '<xml><getter>ddAccountNumber</getter></xml>', 200, '0', null, true, 7, '---', false, false),
       (72, 3, 'hs_hr_emp_directdebit.dd_account_type', 'Direct Deposit Account Type', 'ddAccountType', 'false', null,
        null, 'label', '<xml><getter>ddAccountType</getter></xml>', 200, '0', null, true, 7, '---', false, false),
       (73, 3, 'hs_hr_emp_directdebit.dd_routing_num', 'Direct Deposit Routing Number', 'ddRoutingNumber', 'false',
        null, null, 'label', '<xml><getter>ddRoutingNumber</getter></xml>', 200, '0', null, true, 7, '---', false,
        false),
       (74, 3, 'hs_hr_emp_directdebit.dd_amount', 'Direct Deposit Amount', 'ddAmount', 'false', null, null, 'label',
        '<xml><getter>ddAmount</getter></xml>', 200, '0', null, true, 7, '---', false, false),
       (75, 3, 'hs_hr_emp_contract_extend.econ_extend_start_date', 'Contract Start Date', 'empContStartDate', 'false',
        null, null, 'labelDate', '<xml><getter>empContStartDate</getter></xml>', 200, '0', null, true, 6, '---', false,
        false),
       (76, 3, 'hs_hr_emp_contract_extend.econ_extend_end_date', 'Contract End Date', 'empContEndDate', 'false', null,
        null, 'labelDate', '<xml><getter>empContEndDate</getter></xml>', 200, '0', null, true, 6, '---', false, false),
       (77, 3, 'ohrm_job_title.job_title', 'Job Title', 'empJobTitle', 'false', null, null, 'label',
        '<xml><getter>empJobTitle</getter></xml>', 200, '0', null, true, 6, '---', false, false),
       (78, 3, 'ohrm_employment_status.name', 'Employment Status', 'empEmploymentStatus', 'false', null, null, 'label',
        '<xml><getter>empEmploymentStatus</getter></xml>', 200, '0', null, true, 6, '---', false, false),
       (80, 3, 'ohrm_job_category.name', 'Job Category', 'empJobCategory', 'false', null, null, 'label',
        '<xml><getter>empJobCategory</getter></xml>', 200, '0', null, true, 6, '---', false, false),
       (81, 3, 'hs_hr_employee.joined_date', 'Joined Date', 'empJoinedDate', 'false', null, null, 'labelDate',
        '<xml><getter>empJoinedDate</getter></xml>', 100, '0', null, true, 6, '---', false, false),
       (82, 3, 'ohrm_subunit.name', 'Sub Unit', 'empSubUnit', 'false', null, null, 'label',
        '<xml><getter>empSubUnit</getter></xml>', 200, '0', null, true, 6, '---', false, false),
       (83, 3, 'ohrm_location.name', 'Location', 'empLocation', 'false', null, null, 'label',
        '<xml><getter>empLocation</getter></xml>', 200, '0', null, true, 6, '---', false, false),
       (84, 3, 'hs_hr_emp_passport.ep_passport_num', 'Number', 'empPassportNo', 'false', null, null, 'label',
        '<xml><getter>empPassportNo</getter></xml>', 200, '0', null, true, 5, '---', false, false),
       (85, 3, 'hs_hr_emp_passport.ep_passportissueddate', 'Issued Date', 'empPassportIssuedDate', 'false', null, null,
        'labelDate', '<xml><getter>empPassportIssuedDate</getter></xml>', 100, '0', null, true, 5, '---', false, false),
       (86, 3, 'hs_hr_emp_passport.ep_passportexpiredate', 'Expiry Date', 'empPassportExpiryDate', 'false', null, null,
        'labelDate', '<xml><getter>empPassportExpiryDate</getter></xml>', 100, '0', null, true, 5, '---', false, false),
       (87, 3, 'hs_hr_emp_passport.ep_i9_status', 'Eligibility Status', 'empPassportEligibleStatus', 'false', null,
        null, 'label', '<xml><getter>empPassportEligibleStatus</getter></xml>', 200, '0', null, true, 5, '---', false,
        false),
       (88, 3, 'hs_hr_emp_passport.cou_code', 'Issued By', 'empPassportIssuedBy', 'false', null, null, 'label',
        '<xml><getter>empPassportIssuedBy</getter></xml>', 200, '0', null, true, 5, '---', false, false),
       (89, 3, 'hs_hr_emp_passport.ep_i9_review_date', 'Eligibility Review Date', 'empPassportEligibleReviewDate',
        'false', null, null, 'labelDate', '<xml><getter>empPassportEligibleReviewDate</getter></xml>', 200, '0', null,
        true, 5, '---', false, false),
       (90, 3, 'hs_hr_emp_passport.ep_comments', 'Comments', 'empPassportComments', 'false', null, null, 'label',
        '<xml><getter>empPassportComments</getter></xml>', 200, '0', null, true, 5, '---', false, false),
       (91, 3, 'subordinate.emp_lastname', 'Last Name', 'subordinateLastName', 'false', null, null, 'label',
        '<xml><getter>subordinateLastName</getter></xml>', 200, '0', null, true, 8, '---', false, false),
       (92, 3, 'CASE hs_hr_emp_language.fluency WHEN 1 THEN "Writing" WHEN 2 THEN "Speaking" WHEN 3 THEN "Reading" END',
        'Fluency', 'langFluency', 'false', null, null, 'label', '<xml><getter>langFluency</getter></xml>', 200, '0',
        null, true, 13, '---', false, false),
       (93, 3, 'supervisor_reporting_method.reporting_method_name', 'Reporting Method', 'supReportingMethod', 'false',
        null, null, 'label', '<xml><getter>supReportingMethod</getter></xml>', 200, '0', null, true, 9, '---', false,
        false),
       (94, 3, 'subordinate_reporting_method.reporting_method_name', 'Reporting Method', 'subReportingMethod', 'false',
        null, null, 'label', '<xml><getter>subReportingMethod</getter></xml>', 200, '0', null, true, 8, '---', false,
        false),
       (95, 3, 'CASE hs_hr_emp_passport.ep_passport_type_flg WHEN 1 THEN "Passport" WHEN 2 THEN "Visa" END',
        'Document Type', 'documentType', 'false', null, null, 'label', '<xml><getter>documentType</getter></xml>', 200,
        '0', null, true, 5, '---', false, false),
       (97, 3, 'hs_hr_employee.emp_other_id', 'Other Id', 'otherId', 'false', null, null, 'label',
        '<xml><getter>otherId</getter></xml>', 100, '0', null, false, 1, '---', false, false),
       (98, 3, 'hs_hr_emp_emergency_contacts.eec_seqno', 'ecSeqNo', 'ecSeqNo', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 3, '---', false, true),
       (99, 3, 'hs_hr_emp_dependents.ed_seqno', 'SeqNo', 'edSeqNo', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 4, '---', false, true),
       (100, 3, 'hs_hr_emp_passport.ep_seqno', 'SeqNo', 'epSeqNo', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 5, '---', false, true),
       (101, 3, 'hs_hr_emp_basicsalary.id', 'salaryId', 'salaryId', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 7, '---', false, true),
       (102, 3, 'subordinate.emp_number', 'subordinateId', 'subordinateId', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 8, '---', false, true),
       (103, 3, 'supervisor.emp_number', 'supervisorId', 'supervisorId', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 9, '---', false, true),
       (104, 3, 'hs_hr_emp_work_experience.eexp_seqno', 'workExpSeqNo', 'workExpSeqNo', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 10, '---', false, true),
       (105, 3, 'ohrm_emp_education.education_id', 'empEduCode', 'empEduCode', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 11, '---', false, true),
       (106, 3, 'hs_hr_emp_skill.skill_id', 'empSkillCode', 'empSkillCode', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 12, '---', false, true),
       (107, 3, 'hs_hr_emp_language.lang_id', 'empLangCode', 'empLangCode', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 13, '---', false, true),
       (108, 3, 'hs_hr_emp_language.fluency', 'empLangType', 'empLangType', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 13, '---', false, true),
       (109, 3, 'ohrm_emp_license.license_id', 'empLicenseCode', 'empLicenseCode', 'false', null, null, 'label',
        '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 14, '---', false, true),
       (110, 3, 'hs_hr_emp_member_detail.membship_code', 'membershipCode', 'membershipCode', 'false', null, null,
        'label', '<xml><getter>ecMobile</getter></xml>', 100, '0', null, true, 15, '---', false, true),
       (112, 3,
        'ROUND(DATEDIFF(hs_hr_emp_work_experience.eexp_to_date, hs_hr_emp_work_experience.eexp_from_date)/365,1)',
        'Duration', 'expDuration', 'false', null, null, 'label', '<xml><getter>expDuration</getter></xml>', 100, '0',
        null, true, 10, '---', false, false),
       (113, 3, 'ohrm_emp_termination.termination_date', 'Termination Date', 'terminationDate', 'false', null, null,
        'labelDate', '<xml><getter>terminationDate</getter></xml>', 100, '0', null, true, 6, '---', false, false),
       (114, 3, 'ohrm_emp_termination_reason.name', 'Termination Reason', 'terminationReason', 'false', null, null,
        'label', '<xml><getter>terminationReason</getter></xml>', 100, '0', null, true, 6, '---', false, false),
       (115, 3, 'ohrm_emp_education.institute', 'Institute', 'getInstitute', 'false', null, null, 'label',
        '<xml><getter>getInstitute</getter></xml>', 80, '0', null, true, 11, '---', false, false),
       (116, 3, 'ohrm_emp_education.major', 'Major/Specialization', 'getMajor', 'false', null, null, 'label',
        '<xml><getter>getMajor</getter></xml>', 80, '0', null, true, 11, '---', false, false),
       (117, 3, 'ohrm_emp_education.start_date', 'Start Date', 'getStartDate', 'false', null, null, 'labelDate',
        '<xml><getter>getStartDate</getter></xml>', 80, '0', null, true, 11, '---', false, false),
       (118, 3, 'ohrm_emp_education.end_date', 'End Date', 'getEndDate', 'false', null, null, 'labelDate',
        '<xml><getter>getEndDate</getter></xml>', 80, '0', null, true, 11, '---', false, false),
       (119, 3, 'ohrm_emp_license.license_no', 'License Number', 'getLicenseNo', 'false', null, null, 'label',
        '<xml><getter>getLicenseNo</getter></xml>', 200, '0', null, true, 14, '---', false, false),
       (120, 3, 'ohrm_emp_termination.note', 'Termination Note', 'getNote', 'false', null, null, 'label',
        '<xml><getter>getNote</getter></xml>', 100, '0', null, true, 6, '---', false, false);


INSERT INTO `ohrm_group_field` (`group_field_id`, `name`, `group_by_clause`, `group_field_widget`)
VALUES (1, 'activity id', 'GROUP BY ohrm_project_activity.activity_id', null),
       (2, 'employee number', 'GROUP BY hs_hr_employee.emp_number', null);

INSERT INTO `ohrm_selected_filter_field` (`report_id`, `filter_field_id`, `filter_field_order`, `value1`, `value2`,
                                          `where_condition`, `type`)
VALUES (1, 1, 1, null, null, null, 'Runtime'),
...
INSERT INTO `ohrm_selected_display_field` (`id`, `display_field_id`, `report_id`)
VALUES (2, 2, 1),
       (4, 8, 2),
       (5, 9, 5),
       (6, 10, 5),
...
INSERT INTO `ohrm_selected_display_field_group`(`id`, `report_id`, `display_field_group_id`)
VALUES (1, 5, 1),
       (2, 5, 2),
       (3, 5, 3),
       (4, 5, 4),
...
INSERT INTO `ohrm_composite_display_field` (`composite_display_field_id`, `report_group_id`, `name`, `label`,
                                            `field_alias`, `is_sortable`, `sort_order`, `sort_field`, `element_type`,
                                            `element_property`, `width`, `is_exportable`, `text_alignment_style`,
                                            `is_value_list`, `display_field_group_id`, `default_value`, `is_encrypted`,
                                            `is_meta`)
VALUES (1, 1,
        'IF(hs_hr_employee.termination_id IS NULL, CONCAT(hs_hr_employee.emp_firstname, " " ,hs_hr_employee.emp_lastname), CONCAT(hs_hr_employee.emp_firstname, " " ,hs_hr_employee.emp_lastname, " (Past Employee)"))',
        'Employee Name', 'employeeName', 'false', null, null, 'label', '<xml><getter>employeeName</getter></xml>', 300,
        '0', null, false, null, 'Deleted Employee', false, false),
       (2, 1, 'CONCAT(ohrm_customer.name, " - " ,ohrm_project.name)', 'Project Name', 'projectname', 'false', null,
        null, 'label', '<xml><getter>projectname</getter></xml>', 300, '0', null, false, null, null, false, false);

INSERT INTO `ohrm_selected_composite_display_field` (`id`, `composite_display_field_id`, `report_id`)
VALUES (1, 1, 3),
       (2, 1, 4),
       (3, 2, 2);

INSERT INTO `ohrm_summary_display_field` (`summary_display_field_id`, `function`, `label`, `field_alias`, `is_sortable`,
                                          `sort_order`, `sort_field`, `element_type`, `element_property`, `width`,
                                          `is_exportable`, `text_alignment_style`, `is_value_list`,
                                          `display_field_group_id`, `default_value`)
VALUES (1, 'ROUND(COALESCE(sum(duration)/3600, 0),2)', 'Time (Hours)', 'totalduration', 'false', null, null, 'label',
        '<xml><getter>totalduration</getter></xml>', 100, 'false', 'right', false, null, null),
       (2,
        'ROUND(COALESCE(sum(TIMESTAMPDIFF(SECOND , ohrm_attendance_record.punch_in_utc_time , ohrm_attendance_record.punch_out_utc_time))/3600, 0),2)',
        'Time (Hours)', 'totalduration', 'false', null, null, 'label', '<xml><getter>totalduration</getter></xml>', 100,
        'false', 'right', false, null, null);

INSERT INTO `ohrm_selected_group_field` (`group_field_id`, `summary_display_field_id`, `report_id`)
VALUES (1, 1, 1),
       (1, 1, 2),
       (2, 1, 3),
       (2, 2, 4);

INSERT INTO `ohrm_subunit`
VALUES (1, 'Organization', '', '', 1, 2, 0);


INSERT INTO `ohrm_emp_termination_reason`
VALUES (1, 'Other'),
       (2, 'Retired'),
...
INSERT INTO `ohrm_user_role` (`id`, `name`, `display_name`, `is_assignable`, `is_predefined`)
...
INSERT INTO `ohrm_nationality` (`id`, `name`)
VALUES (1, 'Afghan'),
       (2, 'Albanian'),
       (3, 'Algerian'),
       (4, 'American'),
...
INSERT INTO `ohrm_email_notification` (`id`, `name`, `is_enable`)
VALUES (1, 'Leave Applications', 0),
       (2, 'Leave Assignments', 0),
       (3, 'Leave Approvals', 0),
       (4, 'Leave Cancellations', 0),
       (5, 'Leave Rejections', 0);

INSERT INTO `ohrm_module` (`id`, `name`, `status`)
VALUES (1, 'core', 1),
       (2, 'admin', 1),
       (3, 'pim', 1),
       (4, 'leave', 1),
...
INSERT INTO ohrm_screen (`id`, `name`, `module_id`, `action_url`)
VALUES (1, 'User List', 2, 'viewSystemUsers'),
...
VALUES (1, 'Admin', 74, NULL, 1, 100, NULL, 1),
...
VALUES (1, 'personal_information', 'PIM - Personal Details', 1, NULL, 1, NULL),
...
INSERT INTO `ohrm_user_role_data_group` (`user_role_id`, `data_group_id`, `can_read`, `can_create`, `can_update`,
                                         `can_delete`, `self`)
VALUES (1, 1, 1, NULL, 1, NULL, 0),
       (1, 2, 1, 1, 1, 1, 0),
       (1, 3, 1, NULL, 1, NULL, 0),
       (1, 4, 1, NULL, 1, NULL, 0),
       (1, 5, 1, 1, 1, 1, 0),
...
INSERT INTO `ohrm_job_category` (`name`)
VALUES ('Officials and Managers'),
       ('Professionals'),
       ('Technicians'),
       ('Sales Workers'),
       ('Operatives'),
...
INSERT INTO ohrm_email(`id`, `name`)
VALUES (1, 'leave.apply'),
       (2, 'leave.assign'),
       (3, 'leave.approve'),
       (4, 'leave.cancel'),
       (5, 'leave.reject'),
...
INSERT INTO ohrm_email_template(`id`, `email_id`, `locale`, `performer_role`, `recipient_role`, `body`, `subject`)
VALUES (1, 1, 'en_US', NULL, 'supervisor',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/apply/leaveApplicationBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/apply/leaveApplicationSubject.txt'),
       (2, 1, 'en_US', NULL, 'subscriber',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/apply/leaveApplicationSubscriberBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/apply/leaveApplicationSubject.txt'),
       (3, 3, 'en_US', NULL, 'ess',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/approve/leaveApprovalBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/approve/leaveApprovalSubject.txt'),
       (4, 3, 'en_US', NULL, 'subscriber',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/approve/leaveApprovalSubscriberBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/approve/leaveApprovalSubscriberSubject.txt'),
       (5, 2, 'en_US', NULL, 'ess',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentSubject.txt'),
       (6, 2, 'en_US', NULL, 'supervisor',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentBodyForSupervisors.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentSubjectForSupervisors.txt'),
       (7, 2, 'en_US', NULL, 'subscriber',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentSubscriberBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/assign/leaveAssignmentSubscriberSubject.txt'),
       (8, 4, 'en_US', 'ess', 'supervisor',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveEmployeeCancellationBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveEmployeeCancellationSubject.txt'),
       (9, 4, 'en_US', 'ess', 'subscriber',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveEmployeeCancellationSubscriberBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveEmployeeCancellationSubscriberSubject.txt'),
       (10, 4, 'en_US', NULL, 'ess',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveCancellationBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveCancellationSubject.txt'),
       (11, 4, 'en_US', NULL, 'subscriber',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveCancellationSubscriberBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/cancel/leaveCancellationSubscriberSubject.txt'),
       (12, 5, 'en_US', NULL, 'ess',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/reject/leaveRejectionBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/reject/leaveRejectionSubject.txt'),
       (13, 5, 'en_US', NULL, 'subscriber',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/reject/leaveRejectionSubscriberBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/reject/leaveRejectionSubscriberSubject.txt'),
       (14, 6, 'en_US', NULL, 'ess',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/change/leaveChangeBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/change/leaveChangeSubject.txt'),
       (15, 6, 'en_US', NULL, 'subscriber',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/change/leaveChangeSubscriberBody.txt',
        'orangehrmLeavePlugin/modules/leave/templates/mail/en_US/change/leaveChangeSubscriberSubject.txt');

INSERT INTO ohrm_email_processor(`id`, `email_id`, `class_name`)
VALUES (1, 1, 'LeaveEmailProcessor'),
...
INSERT INTO ohrm_leave_entitlement_type(`id`, `name`, `is_editable`)
VALUES (1, 'Added', 1);

INSERT INTO ohrm_advanced_report (id, name, definition)
VALUES (1, 'Leave Entitlements and Usage Report', '
<report>
    <settings>
        <csv>
...
INSERT INTO ohrm_advanced_report (id, name, definition)
VALUES (2, 'Leave Entitlements and Usage Report', '
<report>
    <settings>
        <csv>
            <include_group_header>1</include_group_header>
...
INSERT INTO `ohrm_leave_status` (`status`, `name`)
VALUES (-1, 'REJECTED'),
       (0, 'CANCELLED'),
       (1, 'PENDING APPROVAL'),
       (2, 'SCHEDULED'),
...
INSERT INTO ohrm_home_page (`user_role_id`, `action`, `enable_class`, `priority`)
VALUES (1, 'pim/viewEmployeeList', NULL, 10),
       (2, 'pim/viewMyDetails', NULL, 0);

INSERT INTO ohrm_module_default_page (`module_id`, `user_role_id`, `action`, `enable_class`, `priority`)
VALUES (2, 1, 'admin/viewSystemUsers', NULL, 20),
...
INSERT INTO `hs_hr_config`(`key`, `value`)
VALUES ('beacon.activation_acceptance_status', 'off'),
       ('beacon.company_name', ''),
...
INSERT INTO `ohrm_datapoint_type`(`id`, `name`, `action_class`)
VALUES (1, 'config', 'configDatapointProcessor'),
       (2, 'count', 'countDatapointProcessor'),
       (3, 'session', 'sessionDatapointProcessor'),
       (4, 'organization', 'OrganizationDataProcessor');

SET
@admin_user_role_id := (SELECT id FROM ohrm_user_role WHERE name = 'Admin' LIMIT 1);
SET
@ess_user_role_id := (SELECT id FROM ohrm_user_role WHERE name = 'ESS' LIMIT 1);

SET
@admin_home_page := (SELECT id FROM ohrm_home_page WHERE user_role_id = @admin_user_role_id LIMIT 1);
SET
@ess_home_page := (SELECT id FROM ohrm_home_page WHERE user_role_id = @ess_user_role_id LIMIT 1);

UPDATE ohrm_home_page
SET action   = 'dashboard/index',
    priority = '15'
WHERE user_role_id = @admin_home_page;
UPDATE ohrm_home_page
SET action   = 'dashboard/index',
    priority = '5'
WHERE user_role_id = @ess_home_page;

INSERT INTO ohrm_module (name, status)
VALUES ('dashboard', 1);
SET
@dashboard_module := (SELECT id FROM ohrm_module WHERE name = 'dashboard' LIMIT 1);

INSERT INTO ohrm_screen (name, module_id, action_url)
VALUES ('Dashboard', @dashboard_module, 'index');
SET
@dashboard_screen := (SELECT id FROM ohrm_screen WHERE name = 'Dashboard' LIMIT 1);

INSERT INTO ohrm_menu_item (menu_title, screen_id, parent_id, level, order_hint, url_extras, status)
VALUES ('Dashboard', @dashboard_screen, NULL, 1, 800, NULL, 1);

INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (@admin_user_role_id, @dashboard_screen, 1, 0, 0, 0),
       (@ess_user_role_id, @dashboard_screen, 1, 0, 0, 0);

INSERT INTO `ohrm_reviewer_group` (`id`, `name`, `piority`)
VALUES (1, 'Supervisor', 1),
       (2, 'Employee', 2);

SET
@admin_role_id := (SELECT `id` FROM ohrm_user_role WHERE `name` = 'Admin');
SET
@ess_role_id := (SELECT `id` FROM ohrm_user_role WHERE `name` = 'ESS');
SET
@supervisor_role_id := (SELECT `id` FROM ohrm_user_role WHERE `name` = 'Supervisor');

INSERT INTO `ohrm_module` (`name`, `status`)
VALUES ('performance', 1);

SET
@module_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Save KPI', @module_id, 'saveKpi');
SET
@save_kpi_screen_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Saearch KPI', @module_id, 'searchKpi');
SET
@search_kpi_screen_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('My Reviews', @module_id, 'myPerformanceReview');
SET
@my_reviews_screen_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Add Review', @module_id, 'saveReview');
SET
@add_review_screen_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Review Evaluate', @module_id, 'reviewEvaluate');
SET
@review_evaluate_screen_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Review Evaluate By Admin', @module_id, 'reviewEvaluateByAdmin');
SET
@review_evaluate_admin_screen_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Search Evaluate Performance', @module_id, 'searchEvaluatePerformancReview');
SET
@search_evaluate_performance_screen_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Search Performance Review', @module_id, 'searchPerformancReview');
SET
@search_performance_review_screen_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('Performance', NULL, NULL, 1, 700, '', 1);
SET
@performance_menu_id := (SELECT `id` FROM ohrm_menu_item WHERE `menu_title` = 'Performance' AND `level` = 1);

INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('Configure', NULL, @performance_menu_id, 2, 100, '', 1);
SET
@ConfigureKPI_screen_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('Manage Reviews', NULL, @performance_menu_id, 2, 200, '', 1);
SET
@Manage_Reviews_screen_id := (SELECT LAST_INSERT_ID());


INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('KPIs', @search_kpi_screen_id, @ConfigureKPI_screen_id, 3, 100, '', 1),
...
INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (@admin_role_id, @save_kpi_screen_id, 1, 1, 1, 0),
...
SET
@admin_user_role := (SELECT id FROM ohrm_user_role WHERE name = 'Admin');
SET
@ess_user_role := (SELECT id FROM ohrm_user_role WHERE name = 'ESS');

SET
@performance_module_id:= (SELECT `id` FROM `ohrm_module` WHERE `name` = 'performance');

-- Admin Section. Manage Trackers.
INSERT INTO `ohrm_screen` (`name`, `module_id`, `action_url`)
VALUES ('Manage_Trackers', @performance_module_id, 'addPerformanceTracker');
SET
@manage_performance_trackers_screen_id :=  (SELECT LAST_INSERT_ID());

SET
@performance_menu_id:= (SELECT id FROM ohrm_menu_item where menu_title = 'Performance');
INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('Trackers', @manage_performance_trackers_screen_id, @ConfigureKPI_screen_id, 3, 200, NULL, 1);

INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (@admin_user_role, @manage_performance_trackers_screen_id, 1, 1, 1, 1),
       (@ess_user_role, @manage_performance_trackers_screen_id, 0, 0, 0, 0);

-- Admin/ ESS Section Employee Trackers.
INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Employee_Trackers', @performance_module_id, 'viewEmployeePerformanceTrackerList');
SET
@employee_trackers_screen_id :=  (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('Employee Trackers', @employee_trackers_screen_id, @performance_menu_id, 2, 800, NULL, 1);

INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (@admin_user_role, @employee_trackers_screen_id, 1, 1, 1, 1),
       (@ess_user_role, @employee_trackers_screen_id, 1, 1, 1, 0);

-- ESS secetion. My Trackers.
INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('My_Trackers', @performance_module_id, 'viewMyPerformanceTrackerList');
SET
@my_trackers_screen_id :=  (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('My Trackers', @my_trackers_screen_id, @performance_menu_id, 2, 700, NULL, 1);

INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (@admin_user_role, @my_trackers_screen_id, 0, 0, 0, 0),
       (@ess_user_role, @my_trackers_screen_id, 1, 0, 1, 0);

-- Tracker Logs. (No menu item)
INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Employee_Tracker_Logs', @performance_module_id, 'addPerformanceTrackerLog');
SET
@employee_tracker_logs_screen_id :=  (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (@admin_user_role, @employee_tracker_logs_screen_id, 1, 1, 1, 0),
...
INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Directory', @module_id, 'viewDirectory');

SET
@directory_configuration_screen_id := (SELECT LAST_INSERT_ID());

INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('Directory', @directory_configuration_screen_id, null, 1, 1000, '/reset/1', 1);
...
INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (@admin_role_id, @directory_configuration_screen_id, 1, 1, 1, 1),
...
INSERT INTO `hs_hr_config` (`key`, `value`)
VALUES ('domain.name', 'localhost');

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Manage OpenId', 2, 'openIdProvider');
SET
@opnid_screen_id := (SELECT LAST_INSERT_ID());

SET
@admin_menu_id := (SELECT `id` FROM ohrm_menu_item WHERE `menu_title` = 'Admin' AND `level` = 1);
SET
@configuration_id := (SELECT `id` FROM ohrm_menu_item WHERE `menu_title` = 'Configuration' AND `level` = 2 AND parent_id = @admin_menu_id);
SET
@max_order := (SELECT MAX(`order_hint`) FROM ohrm_menu_item WHERE parent_id = @configuration_id);

INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('Social Media Authentication', @opnid_screen_id, @configuration_id, 3, @max_order + 100, NULL, 1);

INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (1, @opnid_screen_id, 1, 1, 1, 0);

INSERT INTO hs_hr_config (`key`, `value`)
VALUES ('openId.provider.added', 'on');


INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Register OAuth Client', 2, 'registerOAuthClient');
SET
@oauth_client_screen_id := (SELECT LAST_INSERT_ID());
...
INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('Register OAuth Client', @oauth_client_screen_id, @configuration_id, 3, @max_order + 100, NULL, 1);

INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (1, @oauth_client_screen_id, 1, 1, 1, 0);

INSERT INTO hs_hr_config (`key`, `value`)
VALUES ('open_source_integrations', '<xml>
<integrations>
</integrations>
</xml>
');
...
INSERT INTO `hs_hr_config` (`key`, `value`)
VALUES ('authentication.status', 'Enable'),
...
set
@module_id := (SELECT id FROM ohrm_module WHERE name = 'maintenance');
set
@admin_role_id := (SELECT id FROM ohrm_user_role WHERE name = 'Admin');

INSERT INTO ohrm_screen (name, module_id, action_url)
VALUES ('Purge Employee Records', @module_id, 'purgeEmployee'),
       ('Purge Candidate Records', @module_id, 'purgeCandidateData'),
       ('Access Employee Records', @module_id, 'accessEmployeeData');

set
@purge_employee_screen_id := (SELECT id FROM ohrm_screen WHERE action_url = 'purgeEmployee');
set
@purge_candidate_screen_id := (SELECT id FROM ohrm_screen WHERE action_url = 'purgeCandidateData');
set
@access_employee_records_screen_id := (SELECT id FROM ohrm_screen WHERE action_url = 'accessEmployeeData');

INSERT INTO ohrm_menu_item (menu_title, screen_id, parent_id, level, order_hint, url_extras, status)
VALUES ('Maintenance', @purge_employee_screen_id, NULL, '1', '1200', NULL, '1');

set
@parent_menu_id := (SELECT id FROM ohrm_menu_item WHERE menu_title = 'Maintenance');

INSERT INTO ohrm_menu_item (menu_title, screen_id, parent_id, level, order_hint, url_extras, status)
VALUES ('Purge Records', NULL, @parent_menu_id, 2, '100', null, 1),
       ('Access Records', @access_employee_records_screen_id, @parent_menu_id, 2, '200', null, 1);

set
@parent_menu_id_level_2:= (SELECT id FROM ohrm_menu_item WHERE menu_title = 'Purge Records');
INSERT INTO ohrm_menu_item (menu_title, screen_id, parent_id, level, order_hint, url_extras, status)
VALUES ('Employee Records', @purge_employee_screen_id, @parent_menu_id_level_2, 3, '100', null, 1),
...
VALUES (@admin_role_id, @purge_employee_screen_id, 1),
       (@admin_role_id, @purge_candidate_screen_id, 1),
       (@admin_role_id, @access_employee_records_screen_id, 1);

INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (@admin_role_id, @access_employee_records_screen_id, 1, 1, 1, 1);

INSERT INTO ohrm_data_group (name, description, can_read, can_create, can_update, can_delete)
VALUES ('GDPR Employee', 'Employee Records purge or Extract- Tasks', 1, 1, 1, 1);

SET
@data_group_id := (SELECT id FROM ohrm_data_group WHERE name = 'GDPR Employee');

INSERT INTO ohrm_data_group_screen (data_group_id, screen_id, permission)
VALUES (@data_group_id, @purge_employee_screen_id, 1),
...
VALUES (@admin_role_id, @data_group_id, 1, 1, 1, 1, 1);

-- Add module to `ohrm_module` table
INSERT INTO ohrm_module (name, status)
VALUES ('marketPlace', '1');
set
@module_id := (SELECT id FROM ohrm_module WHERE name = 'marketPlace');

-- Add screens to `ohrm_screen` table
INSERT INTO ohrm_screen (name, module_id, action_url)
VALUES ('Marcket Place Home Page', @module_id, 'ohrmAddons');

set
@MP_home_screen_id := (SELECT id FROM ohrm_screen WHERE action_url = 'ohrmAddons');
set
@admin_role_id := (SELECT id FROM ohrm_user_role WHERE name = 'Admin');
set
@ESS_role_id := (SELECT id FROM ohrm_user_role WHERE name = 'ESS');
...
INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (@admin_role_id, @MP_home_screen_id, 1, 0, 0, 0),
       (@ESS_role_id, @MP_home_screen_id, 1, 0, 0, 0),
       (@Supervisor_role_id, @MP_home_screen_id, 1, 0, 0, 0);

INSERT INTO `hs_hr_config` (`key`, `value`)
VALUES ('base_url', 'https://marketplace.orangehrm.com');

-- Add data group permissions
INSERT INTO ohrm_data_group (name, description, can_read, can_create, can_update, can_delete)
VALUES ('Marketplace', 'Install or Uninstall addons- Tasks', 1, 1, 0, 1);

SET
@data_group_id := (SELECT id FROM ohrm_data_group WHERE name = 'Marketplace');

INSERT INTO ohrm_data_group_screen (data_group_id, screen_id, permission)
VALUES (@data_group_id, @MP_home_screen_id, 1);

-- Add default data group permission
INSERT INTO ohrm_user_role_data_group (user_role_id, data_group_id, can_read, can_create, can_update, can_delete, self)
VALUES (@admin_role_id, @data_group_id, 1, 1, 0, 1, 0),
       (@ESS_role_id, @data_group_id, 1, 0, 0, 0, 0),
       (@Supervisor_role_id, @data_group_id, 1, 0, 0, 0, 0);

-- Buzz plugin
INSERT INTO `hs_hr_config`(`key`, `value`)
VALUES ('buzz_refresh_time', '60000'),
       ('buzz_share_count', '10'),
...
INSERT INTO `ohrm_data_group` (`name`, `description`, `can_read`, `can_create`, `can_update`, `can_delete`)
VALUES ('buzz_link', 'buzz link permition ', 1, 1, 1, 0);

SET
@buzz_link_data_group_id := (SELECT id FROM `ohrm_data_group` WHERE `name` = 'buzz_link');

INSERT INTO `ohrm_user_role_data_group` (`user_role_id`, `data_group_id`, `can_read`, `can_create`, `can_update`,
                                         `can_delete`, `self`)
VALUES (@ESS_role_id, @buzz_link_data_group_id, 1, 1, 1, 0, 0),
       (@Supervisor_role_id, @buzz_link_data_group_id, 1, 1, 1, 0, 0);

INSERT INTO `ohrm_data_group` (`name`, `description`, `can_read`, `can_create`, `can_update`, `can_delete`)
VALUES ('buzz_link_admin', 'buzz link permition for admin', 1, 1, 1, 0);

SET
@buzz_link_admin_data_group_id := (SELECT id FROM `ohrm_data_group` WHERE `name` = 'buzz_link_admin');

INSERT INTO `ohrm_user_role_data_group` (`user_role_id`, `data_group_id`, `can_read`, `can_create`, `can_update`,
                                         `can_delete`, `self`)
VALUES (@admin_role_id, @buzz_link_admin_data_group_id, 1, 1, 1, 0, 0);

INSERT INTO `hs_hr_config`(`key`, `value`)
VALUES ('buzz_comment_text_lenth', '250');

-- Add Buzz As A menu Item
SET
@buzz_module_id = (SELECT `id` FROM `ohrm_module` WHERE `name`='buzz');
INSERT INTO `ohrm_screen`(`name`, `module_id`, `action_url`)
VALUES ('Buzz', @buzz_module_id, 'viewBuzz');
SET
@screen_id=(SELECT `id` FROM `ohrm_screen` WHERE `name`='Buzz');
INSERT INTO `ohrm_menu_item`(`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `status`)
VALUES ('Buzz', @screen_id, NULL, '1', '1500', 1);

INSERT INTO `ohrm_user_role_screen`(`user_role_id`, `screen_id`, `can_read`, `can_create`, `can_update`, `can_delete`)
VALUES (@admin_role_id, @screen_id, 1, 1, 1, 1);
INSERT INTO `ohrm_user_role_screen`(`user_role_id`, `screen_id`, `can_read`, `can_create`, `can_update`, `can_delete`)
VALUES (@ESS_role_id, @screen_id, 1, 1, 1, 1);
INSERT INTO `ohrm_user_role_screen`(`user_role_id`, `screen_id`, `can_read`, `can_create`, `can_update`, `can_delete`)
VALUES (@Supervisor_role_id, @screen_id, 1, 1, 1, 1);

-- i.e. -4 weeks, -2 days, -1 day, -1 month
-- https://www.php.net/manual/en/datetime.formats.relative.php
INSERT INTO `hs_hr_config`(`key`, `value`)
VALUES ('buzz_max_notification_period', '-1 week');

INSERT INTO `ohrm_oauth_scope` (`scope`, `is_default`)
VALUES ('admin', '0'),
       ('user', '0');
INSERT
IGNORE INTO `ohrm_oauth_client`(`client_id`, `client_secret`, `redirect_uri`, `grant_types`, `scope`) VALUES
...
SET
@admin_module_id = (SELECT `id` FROM `ohrm_module` WHERE `name`='admin');

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('Language Packages', @admin_module_id, 'languagePackage'),
...
SET
@language_packages_screen_id=(SELECT `id` FROM `ohrm_screen` WHERE `name`='Language Packages');
SET
@language_customization_screen_id=(SELECT `id` FROM `ohrm_screen` WHERE `name`='Language Customization');
SET
@save_language_customization_screen_id=(SELECT `id` FROM `ohrm_screen` WHERE `name`='Save Language Customization');
SET
@export_language_package_screen_id=(SELECT `id` FROM `ohrm_screen` WHERE `name`='Export Language Package');

SET
@admin_menu_id := (SELECT `id` FROM ohrm_menu_item WHERE `menu_title` = 'Admin' AND `level` = 1);
SET
@configuration_menu_id := (SELECT id FROM ohrm_menu_item where menu_title = 'Configuration' AND `parent_id` = @admin_menu_id);

INSERT INTO ohrm_menu_item (`menu_title`, `screen_id`, `parent_id`, `level`, `order_hint`, `url_extras`, `status`)
VALUES ('Language Packages', @language_packages_screen_id, @configuration_menu_id, 3, 350, '', 1);

INSERT INTO ohrm_user_role_screen (user_role_id, screen_id, can_read, can_create, can_update, can_delete)
VALUES (@admin_role_id, @language_packages_screen_id, 1, 1, 1, 0),
...
INSERT INTO `ohrm_i18n_language` (`name`, `code`, `added`)
VALUES ('Chinese (Simplified, China) - 中文（简体，中国）', 'zh_Hans_CN', 1),
...
INSERT INTO `ohrm_i18n_language` (`name`, `code`, `enabled`)
VALUES ('test - TEST', 'zz_ZZ', 0);

INSERT INTO `ohrm_i18n_language` (`name`, `code`)
VALUES ('Afrikaans (Namibia) - Afrikaans (Namibië)', 'af_NA'),
...
ALTER TABLE `ohrm_menu_item`
    ADD additional_params LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json)';

SET
@pim_module_id := (SELECT `id` FROM ohrm_module WHERE name = 'pim' LIMIT 1);
UPDATE `ohrm_screen`
SET `module_id` = @pim_module_id
WHERE `action_url` = 'viewDefinedPredefinedReports';
UPDATE `ohrm_screen`
SET `module_id` = @pim_module_id
WHERE `action_url` = 'definePredefinedReport';
UPDATE `ohrm_screen`
SET `module_id` = @pim_module_id
WHERE `action_url` = 'displayPredefinedReport';

UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"admin\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Admin';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"pim\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'PIM';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"time\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Time';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"leave\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Leave';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"recruitment\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Recruitment';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"myinfo\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'My Info';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"performance\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Performance';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"dashboard\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Dashboard';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"directory\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Directory';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"maintenance\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Maintenance';
UPDATE `ohrm_menu_item`
SET `additional_params` = '{\"icon\":\"buzz\"}'
WHERE `ohrm_menu_item`.`menu_title` = 'Buzz';

-- Should remove once implement dashboard screen
UPDATE `ohrm_home_page`
SET action='pim/viewPimModule'
...
SET
@ess_role_id := (SELECT `id` FROM ohrm_user_role WHERE `name` = 'ESS' LIMIT 1);
SET
@supervisor_role_id := (SELECT `id` FROM ohrm_user_role WHERE `name` = 'Supervisor' LIMIT 1);
...
SET
@personal_sensitive_information_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'personal_sensitive_information' LIMIT 1);
SET
@apiv2_core_data_groups_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_core_data_groups' LIMIT 1);
SET
@apiv2_core_about_organization_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_core_about_organization' LIMIT 1);
...
VALUES ('OrangeHRM\\Core\\Api\\Rest\\DataGroupAPI', @core_module_id, @apiv2_core_data_groups_data_group_id),
       ('OrangeHRM\\Core\\Api\\Rest\\AboutOrganizationAPI', @core_module_id,
        @apiv2_core_about_organization_data_group_id);
...
SET
@admin_module_id := (SELECT `id` FROM ohrm_module WHERE name = 'admin' LIMIT 1);
SET
@apiv2_admin_education_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_education' LIMIT 1);
SET
@apiv2_admin_employment_status_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_employment_status' LIMIT 1);
SET
@apiv2_admin_job_category_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_job_category' LIMIT 1);
SET
@apiv2_admin_job_specification_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_job_specification' LIMIT 1);
SET
@apiv2_admin_job_title_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_job_title' LIMIT 1);
SET
@apiv2_admin_language_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_language' LIMIT 1);
SET
@apiv2_admin_license_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_license' LIMIT 1);
SET
@apiv2_admin_membership_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_membership' LIMIT 1);
SET
@apiv2_admin_nationality_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_nationality' LIMIT 1);
SET
@apiv2_admin_organization_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_organization' LIMIT 1);
SET
@apiv2_admin_paygrade_currency_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_paygrade_currency' LIMIT 1);
SET
@apiv2_admin_skill_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_skill' LIMIT 1);
SET
@apiv2_admin_subunit_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_subunit' LIMIT 1);
SET
@apiv2_admin_user_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_user' LIMIT 1);
SET
@apiv2_admin_email_configuration_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_email_configuration' LIMIT 1);
SET
@apiv2_admin_oauth_client_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_oauth_client' LIMIT 1);
SET
@apiv2_admin_location_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_location' LIMIT 1);
SET
@apiv2_admin_pay_grade_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_pay_grade' LIMIT 1);
SET
@apiv2_admin_modules_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_modules' LIMIT 1);
SET
@apiv2_admin_work_shift_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_work_shift' LIMIT 1);
SET
@apiv2_admin_work_shift_employee_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name ='apiv2_admin_work_shift_employee' LIMIT 1);
SET
@apiv2_admin_email_subscriptions_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_email_subscriptions' LIMIT 1);
SET
@apiv2_admin_email_subscribers_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_email_subscribers' LIMIT 1);
SET
@apiv2_admin_validation_user_name_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_admin_validation_user_name' LIMIT 1);
...
VALUES ('OrangeHRM\\Admin\\Api\\EducationAPI', @admin_module_id, @apiv2_admin_education_data_group_id),
       ...
       ('OrangeHRM\\Admin\\Api\\PayGradeAllowedCurrencyAPI', @admin_module_id,
        @apiv2_admin_paygrade_currency_data_group_id),
       ...
       ('OrangeHRM\\Admin\\Api\\EmailConfigurationAPI', @admin_module_id,
        @apiv2_admin_email_configuration_data_group_id),
       ...
       ('OrangeHRM\\Admin\\Api\\WorkShiftEmployeeAPI', @admin_module_id,
        @apiv2_admin_work_shift_employee_data_group_id),
       ('OrangeHRM\\Admin\\Api\\EmailSubscriptionAPI', @admin_module_id,
        @apiv2_admin_email_subscriptions_data_group_id),
       ('OrangeHRM\\Admin\\Api\\EmailSubscriberAPI', @admin_module_id, @apiv2_admin_email_subscribers_data_group_id),
       ('OrangeHRM\\Admin\\Api\\ValidationUserNameAPI', @admin_module_id,
        @apiv2_admin_validation_user_name_data_group_id);
...
VALUES ('apiv2_pim_custom_field', 'API-v2 PIM - Custom Fields', 1, 1, 1, 1),
       ...
       ('apiv2_pim_validation_work_email', 'API-v2 PIM - Work Email Validation', 1, 0, 0, 0);

SET
@pim_module_id := (SELECT `id` FROM ohrm_module WHERE name = 'pim' LIMIT 1);
SET
@apiv2_pim_custom_field_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_custom_field' LIMIT 1);
SET
@apiv2_pim_optional_field_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_optional_field' LIMIT 1);
SET
@apiv2_pim_reporting_method_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_reporting_method' LIMIT 1);
SET
@apiv2_pim_termination_reason_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_termination_reason' LIMIT 1);
SET
@apiv2_pim_employee_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee' LIMIT 1);
SET
@apiv2_pim_employee_emergency_contact_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_emergency_contact' LIMIT 1);
SET
@apiv2_pim_employee_contact_detail_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_contact_detail' LIMIT 1);
SET
@apiv2_pim_employee_dependent_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_dependent' LIMIT 1);
SET
@apiv2_pim_employee_education_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_education' LIMIT 1);
SET
@apiv2_pim_employee_immigration_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_immigration' LIMIT 1);
SET
@apiv2_pim_employee_job_detail_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_job_detail' LIMIT 1);
SET
@apiv2_pim_employee_language_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_language' LIMIT 1);
SET
@apiv2_pim_employee_license_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_license' LIMIT 1);
SET
@apiv2_pim_employee_personal_detail_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_personal_detail' LIMIT 1);
SET
@apiv2_pim_employee_picture_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_picture' LIMIT 1);
SET
@apiv2_pim_employee_salary_component_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_salary_component' LIMIT 1);
SET
@apiv2_pim_employee_skill_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_skill' LIMIT 1);
SET
@apiv2_pim_employee_termination_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_termination' LIMIT 1);
SET
@apiv2_pim_employee_work_experience_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_work_experience' LIMIT 1);
SET
@apiv2_pim_employee_employment_contract_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_employment_contract' LIMIT 1);
SET
@apiv2_pim_employee_attachment_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_attachment' LIMIT 1);
SET
@apiv2_pim_employee_custom_field_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_custom_field' LIMIT 1);
SET
@apiv2_pim_employee_allowed_language_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_allowed_language' LIMIT 1);
SET
@apiv2_pim_employee_allowed_license_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_allowed_license' LIMIT 1);
SET
@apiv2_pim_employee_allowed_skill_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_allowed_skill' LIMIT 1);
SET
@apiv2_pim_report_to_supervisor_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_report_to_supervisor' LIMIT 1);
SET
@apiv2_pim_report_to_supervisor_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_report_to_supervisor' LIMIT 1);
SET
@apiv2_pim_report_to_subordinate_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_report_to_subordinate' LIMIT 1);
SET
@apiv2_pim_report_to_allowed_employees_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_report_to_allowed_employees' LIMIT 1);
SET
@apiv2_pim_employee_memberships_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_memberships' LIMIT 1);
SET
@apiv2_pim_tax_exemptions_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_tax_exemptions' LIMIT 1);
SET
@apiv2_pim_employee_work_shift_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_work_shift' LIMIT 1);
SET
@apiv2_pim_employee_count_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_count' LIMIT 1);
SET
@apiv2_pim_employee_csv_import_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_employee_csv_import' LIMIT 1);
SET
@apiv2_pim_defined_reports_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name ='apiv2_pim_defined_reports' LIMIT 1);
SET
@apiv2_pim_reports_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_reports' LIMIT 1);
SET
@apiv2_pim_reports_data_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_reports_data' LIMIT 1);
SET
@apiv2_pim_update_password_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_update_password' LIMIT 1);
SET
@apiv2_pim_validation_work_email_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_pim_validation_work_email' LIMIT 1);
...
VALUES ('OrangeHRM\\Pim\\Api\\CustomFieldAPI', @pim_module_id, @apiv2_pim_custom_field_data_group_id),
       ...
       ('OrangeHRM\\Pim\\Api\\ReportingMethodConfigurationAPI', @pim_module_id,
        @apiv2_pim_reporting_method_data_group_id),
       ('OrangeHRM\\Pim\\Api\\TerminationReasonConfigurationAPI', @pim_module_id,
        @apiv2_pim_termination_reason_data_group_id),
       ('OrangeHRM\\Pim\\Api\\EmployeeAPI', @pim_module_id, @apiv2_pim_employee_data_group_id),
       ('OrangeHRM\\Pim\\Api\\EmpEmergencyContactAPI', @pim_module_id,
        @apiv2_pim_employee_emergency_contact_data_group_id),
       ('OrangeHRM\\Pim\\Api\\EmployeeContactDetailsAPI', @pim_module_id,
        @apiv2_pim_employee_contact_detail_data_group_id),
       ...
       ('OrangeHRM\\Pim\\Api\\EmployeeImmigrationRecordAPI', @pim_module_id,
        @apiv2_pim_employee_immigration_data_group_id),
       ...
       ('OrangeHRM\\Pim\\Api\\EmployeePersonalDetailAPI', @pim_module_id,
        @apiv2_pim_employee_personal_detail_data_group_id),
       ('OrangeHRM\\Pim\\Api\\EmployeePictureAPI', @pim_module_id, @apiv2_pim_employee_picture_data_group_id),
       ('OrangeHRM\\Pim\\Api\\EmployeeSalaryComponentAPI', @pim_module_id,
        @apiv2_pim_employee_salary_component_data_group_id),
       ...
       ('OrangeHRM\\Pim\\Api\\EmployeeWorkExperienceAPI', @pim_module_id,
        @apiv2_pim_employee_work_experience_data_group_id),
       ('OrangeHRM\\Pim\\Api\\EmploymentContractAPI', @pim_module_id,
        @apiv2_pim_employee_employment_contract_data_group_id),
       ...
       ('OrangeHRM\\Pim\\Api\\EmployeeAllowedLanguageAPI', @pim_module_id,
        @apiv2_pim_employee_allowed_language_data_group_id),
       ('OrangeHRM\\Pim\\Api\\EmployeeAllowedLicenseAPI', @pim_module_id,
        @apiv2_pim_employee_allowed_license_data_group_id),
       ('OrangeHRM\\Pim\\Api\\EmployeeAllowedSkillAPI', @pim_module_id,
        @apiv2_pim_employee_allowed_skill_data_group_id),
       ...
       ('OrangeHRM\\Pim\\Api\\EmployeeAllowedReportToEmployeeAPI', @pim_module_id,
        @apiv2_pim_report_to_allowed_employees_data_group_id),
       ...
       ('OrangeHRM\\Pim\\Api\\ValidationEmployeeEmailAPI', @pim_module_id,
        @apiv2_pim_validation_work_email_data_group_id);
...
VALUES (1, 1, 1, 1, 0, @apiv2_pim_custom_field_data_group_id, @admin_role_id),
       ...
       (1, 0, 0, 0, 1, @apiv2_pim_validation_work_email_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 1, @apiv2_pim_validation_work_email_data_group_id, @ess_role_id);
...
VALUES ('apiv2_leave_holiday', 'API-v2 Leave - Holidays', 1, 1, 1, 1),
       ...
       ('apiv2_leave_my_leave_requests', 'API-v2 Leave - My Leave Requests', 1, 1, 1, 0),
       ('apiv2_leave_employee_leave_requests', 'API-v2 Leave - Employee Leave Requests', 1, 1, 1, 0),
       ('apiv2_leave_employee_bulk_leave_requests', 'API-v2 Leave - Employee Bulk Leave Requests', 0, 0, 1, 0),
       ('apiv2_leave_leave_entitlements', 'API-v2 Leave - Leave Entitlements', 1, 1, 1, 1),
       ('apiv2_leave_leave_balance', 'API-v2 Leave - Leave Balance', 1, 0, 0, 0),
       ('apiv2_leave_employee_leave_entitlements', 'API-v2 Leave - Employee Leave Entitlements', 1, 0, 0, 0),
       ('apiv2_leave_leave_entitlements_validation', 'API-v2 Leave - Leave Entitlements Validation', 1, 0, 0, 0),
       ('apiv2_leave_overlap_leaves', 'API-v2 Leave - Overlap Leaves', 1, 0, 0, 0),
       ...
       ('leave_report_employee_leave_entitlements_and_usage', 'Leave - Leave Entitlements and Usage Report - Employee',
        1, 0, 0, 0),
       ...
       ('leave_report_leave_type_leave_entitlements_and_usage',
        'Leave - Leave Entitlements and Usage Report - Leave Type', 1, 0, 0, 0);

SET
@leave_module_id := (SELECT `id` FROM ohrm_module WHERE name = 'leave' LIMIT 1);

SET
@apiv2_leave_holiday_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_holiday' LIMIT 1);
SET
@apiv2_leave_workweek_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_workweek' LIMIT 1);
SET
@apiv2_leave_eligible_leave_types_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_eligible_leave_types' LIMIT 1);
SET
@apiv2_leave_leave_types_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_leave_types' LIMIT 1);
SET
@apiv2_leave_leave_period_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_leave_period' LIMIT 1);
SET
@apiv2_leave_my_leave_requests_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_my_leave_requests' LIMIT 1);
SET
@apiv2_leave_employee_leave_requests_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_employee_leave_requests' LIMIT 1);
SET
@apiv2_leave_employee_bulk_leave_requests_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_employee_bulk_leave_requests' LIMIT 1);
SET
@apiv2_leave_leave_entitlements_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_leave_entitlements' LIMIT 1);
SET
@apiv2_leave_leave_balance_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_leave_balance' LIMIT 1);
SET
@apiv2_leave_employee_leave_entitlements_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_employee_leave_entitlements' LIMIT 1);
SET
@apiv2_leave_leave_entitlements_validation_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_leave_entitlements_validation' LIMIT 1);
SET
@apiv2_leave_overlap_leaves_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_overlap_leaves' LIMIT 1);
SET
@apiv2_leave_leave_request_comment_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_leave_request_comment' LIMIT 1);
SET
@apiv2_leave_leave_comment_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_leave_comment' LIMIT 1);
SET
@apiv2_leave_leave_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_leaves' LIMIT 1);
SET
@apiv2_leave_bulk_leaves_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_bulk_leaves' LIMIT 1);
SET
@apiv2_leave_reports_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_reports' LIMIT 1);
SET
@apiv2_leave_reports_data_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_leave_reports_data' LIMIT 1);
SET
@employee_leave_entitlements_and_usage_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'leave_report_employee_leave_entitlements_and_usage' LIMIT 1);
SET
@my_leave_entitlements_and_usage_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'leave_report_my_leave_entitlements_and_usage' LIMIT 1);
SET
@leave_type_leave_entitlements_and_usage_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'leave_report_leave_type_leave_entitlements_and_usage' LIMIT 1);
...
VALUES ('OrangeHRM\\Leave\\Api\\HolidayAPI', @leave_module_id, @apiv2_leave_holiday_data_group_id),
       ...
       ('OrangeHRM\\Leave\\Api\\EligibleLeaveTypeAPI', @leave_module_id,
        @apiv2_leave_eligible_leave_types_data_group_id),
       ...
       ('OrangeHRM\\Leave\\Api\\EmployeeLeaveRequestAPI', @leave_module_id,
        @apiv2_leave_employee_leave_requests_data_group_id),
       ('OrangeHRM\\Leave\\Api\\EmployeeBulkLeaveRequestAPI', @leave_module_id,
        @apiv2_leave_employee_bulk_leave_requests_data_group_id),
       ...
       ('OrangeHRM\\Leave\\Api\\EmployeeLeaveEntitlementAPI', @leave_module_id,
        @apiv2_leave_employee_leave_entitlements_data_group_id),
       ('OrangeHRM\\Leave\\Api\\ValidationLeaveEntitlementValueAPI', @leave_module_id,
        @apiv2_leave_leave_entitlements_validation_data_group_id),
       ('OrangeHRM\\Leave\\Api\\LeaveOverlapAPI', @leave_module_id, @apiv2_leave_overlap_leaves_data_group_id),
       ('OrangeHRM\\Leave\\Api\\LeaveRequestCommentAPI', @leave_module_id,
        @apiv2_leave_leave_request_comment_data_group_id),
...
VALUES (1, 1, 1, 1, 0, @apiv2_leave_holiday_data_group_id, @admin_role_id),
       ...
       (0, 0, 1, 0, 0, @apiv2_leave_employee_leave_requests_data_group_id, @ess_role_id),
       ...
       (1, 0, 0, 0, 1, @apiv2_leave_leave_balance_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @apiv2_leave_leave_balance_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 1, @apiv2_leave_leave_balance_data_group_id, @ess_role_id),
       (1, 0, 0, 0, 1, @apiv2_leave_leave_balance_data_group_id, @supervisor_role_id),
       (1, 0, 0, 0, 0, @apiv2_leave_leave_balance_data_group_id, @supervisor_role_id),
       (1, 0, 0, 0, 0, @apiv2_leave_employee_leave_entitlements_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @apiv2_leave_leave_entitlements_validation_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 1, @apiv2_leave_overlap_leaves_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @apiv2_leave_overlap_leaves_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 1, @apiv2_leave_overlap_leaves_data_group_id, @ess_role_id),
       (1, 0, 0, 0, 1, @apiv2_leave_overlap_leaves_data_group_id, @supervisor_role_id),
       (1, 0, 0, 0, 0, @apiv2_leave_overlap_leaves_data_group_id, @supervisor_role_id),
       (1, 1, 0, 0, 1, @apiv2_leave_leave_request_comment_data_group_id, @admin_role_id),
       (1, 1, 0, 0, 0, @apiv2_leave_leave_request_comment_data_group_id, @admin_role_id),
       (1, 1, 0, 0, 1, @apiv2_leave_leave_request_comment_data_group_id, @ess_role_id),
       (1, 1, 0, 0, 1, @apiv2_leave_leave_request_comment_data_group_id, @supervisor_role_id),
       (1, 1, 0, 0, 0, @apiv2_leave_leave_request_comment_data_group_id, @supervisor_role_id),
       (1, 1, 0, 0, 0, @apiv2_leave_leave_comment_data_group_id, @admin_role_id),
       (1, 1, 0, 0, 1, @apiv2_leave_leave_comment_data_group_id, @admin_role_id),
       (1, 1, 0, 0, 1, @apiv2_leave_leave_comment_data_group_id, @ess_role_id),
       (1, 1, 0, 0, 0, @apiv2_leave_leave_comment_data_group_id, @supervisor_role_id),
       (1, 1, 0, 0, 1, @apiv2_leave_leave_comment_data_group_id, @supervisor_role_id),
       (1, 0, 1, 0, 0, @apiv2_leave_leave_data_group_id, @admin_role_id),
       (1, 0, 1, 0, 1, @apiv2_leave_leave_data_group_id, @admin_role_id),
       (1, 0, 1, 0, 1, @apiv2_leave_leave_data_group_id, @ess_role_id),
       ...
       (1, 0, 0, 0, 0, @employee_leave_entitlements_and_usage_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @employee_leave_entitlements_and_usage_data_group_id, @supervisor_role_id),
       (1, 0, 0, 0, 0, @my_leave_entitlements_and_usage_data_group_id, @ess_role_id),
...
SET
@saveLocationScreenId := (SELECT `id`
                              FROM ohrm_screen
...
SET
@locations_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'locations' LIMIT 1);
...
SET
@pim_csv_import_screen_id := (SELECT `id` FROM ohrm_screen WHERE action_url = 'pimCsvImport' and name='Data Import' LIMIT 1);
UPDATE `ohrm_screen`
SET `module_id` = @pim_module_id
WHERE `ohrm_screen`.`id` = @pim_csv_import_screen_id;

ALTER TABLE `ohrm_display_field`
    ADD `class_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;
UPDATE `ohrm_display_field`
SET `is_value_list`=0
WHERE `display_field_group_id` = 6;

SET
@personal_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Personal' LIMIT 1);
SET
@contact_details_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Contact Details' LIMIT 1);
SET
@emergency_contacts_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Emergency Contacts' LIMIT 1);
SET
@dependents_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Dependents' LIMIT 1);
SET
@immigration_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Immigration' LIMIT 1);
SET
@job_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Job' LIMIT 1);
SET
@salary_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Salary' LIMIT 1);
SET
@subordinates_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Subordinates' LIMIT 1);
SET
@supervisors_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Supervisors' LIMIT 1);
SET
@work_experience_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Work Experience' LIMIT 1);
SET
@education_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Education' LIMIT 1);
SET
@skills_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Skills' LIMIT 1);
SET
@languages_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Languages' LIMIT 1);
SET
@license_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'License' LIMIT 1);
SET
@memberships_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Memberships' LIMIT 1);
SET
@custom_fields_display_field_group_id := (SELECT `id` FROM ohrm_display_field_group WHERE `name` = 'Custom Fields' LIMIT 1);

UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\EmergencyContact\\EmergencyContact'
WHERE `display_field_group_id` = @emergency_contacts_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\Dependent\\Dependent'
WHERE `display_field_group_id` = @dependents_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\Immigration\\Immigration'
WHERE `display_field_group_id` = @immigration_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\Salary\\Salary'
WHERE `display_field_group_id` = @salary_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\Subordinate\\Subordinate'
WHERE `display_field_group_id` = @subordinates_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\Supervisor\\Supervisor'
WHERE `display_field_group_id` = @supervisors_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\WorkExperience\\WorkExperience'
WHERE `display_field_group_id` = @work_experience_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\Education\\Education'
WHERE `display_field_group_id` = @education_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\Skill\\Skill'
WHERE `display_field_group_id` = @skills_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\Language\\Language'
WHERE `display_field_group_id` = @languages_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\License\\License'
WHERE `display_field_group_id` = @license_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\Membership\\Membership'
WHERE `display_field_group_id` = @memberships_display_field_group_id;

UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\GenericBasicDisplayField'
WHERE `display_field_group_id` = @personal_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\GenericDateDisplayField'
WHERE `field_alias` = 'empBirthday';
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\GenericDateDisplayField'
WHERE `field_alias` = 'licenseExpiryDate';
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\Personal\\EmployeeGender'
WHERE `field_alias` = 'empGender';

UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\GenericBasicDisplayField'
WHERE `display_field_group_id` = @contact_details_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\ContactDetail\\EmployeeAddress'
WHERE `field_alias` = 'address';

UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\GenericBasicDisplayField'
WHERE `display_field_group_id` = @job_display_field_group_id;
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\GenericDateDisplayField'
WHERE `field_alias` = 'empContStartDate';
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\GenericDateDisplayField'
WHERE `field_alias` = 'empContEndDate';
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\GenericDateDisplayField'
WHERE `field_alias` = 'empJoinedDate';
UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\GenericDateDisplayField'
WHERE `field_alias` = 'terminationDate';

UPDATE `ohrm_display_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\DisplayField\\GenericBasicDisplayField'
WHERE `display_field_group_id` = @custom_fields_display_field_group_id;

UPDATE `ohrm_display_field`
SET `field_alias` = 'employeeNationality'
WHERE `field_alias` = 'nationality';
UPDATE `ohrm_display_field`
SET `field_alias` = 'terminationNote'
WHERE `field_alias` = 'getNote';
UPDATE `ohrm_display_field`
SET `field_alias` = 'empTerminationReason'
WHERE `field_alias` = 'terminationReason';
UPDATE `ohrm_display_field`
SET `field_alias` = 'membershipName'
WHERE `field_alias` = 'name';

ALTER TABLE `ohrm_filter_field`
    ADD `class_name` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;

UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\EmployeeNumber'
WHERE `name` = 'employee_name';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\PayGrade'
WHERE `name` = 'pay_grade';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\EmployeeEducation'
WHERE `name` = 'education';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\EmploymentStatus'
WHERE `name` = 'employment_status';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\ServicePeriod'
WHERE `name` = 'service_period';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\JoinedDate'
WHERE `name` = 'joined_date';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\JobTitle'
WHERE `name` = 'job_title';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\EmployeeLanguage'
WHERE `name` = 'language';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\EmployeeSkill'
WHERE `name` = 'skill';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\AgeGroup'
WHERE `name` = 'age_group';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\Subunit'
WHERE `name` = 'sub_unit';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\EmployeeGender'
WHERE `name` = 'gender';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\Location'
WHERE `name` = 'location';
UPDATE `ohrm_filter_field`
SET `class_name` = 'OrangeHRM\\Core\\Report\\FilterField\\IncludeEmployee'
WHERE `name` = 'include';

UPDATE `ohrm_selected_filter_field`
SET `where_condition` = 'eq'
WHERE `where_condition` = '=';
UPDATE `ohrm_selected_filter_field`
SET `where_condition` = 'neq'
WHERE `where_condition` = '<>';
UPDATE `ohrm_selected_filter_field`
SET `where_condition` = 'lt'
WHERE `where_condition` = '<';
UPDATE `ohrm_selected_filter_field`
SET `where_condition` = 'gt'
WHERE `where_condition` = '>';
UPDATE `ohrm_selected_filter_field`
SET `where_condition` = 'between'
WHERE `where_condition` = 'BETWEEN';
UPDATE `ohrm_selected_filter_field`
SET `where_condition` = 'in'
WHERE `where_condition` = 'IN';
UPDATE `ohrm_selected_filter_field`
SET `where_condition` = 'isNull'
WHERE `where_condition` = 'IS NULL';
UPDATE `ohrm_selected_filter_field`
SET `where_condition` = 'isNotNull'
WHERE `where_condition` = 'IS NOT NULL';

SET
@performance_module_id := (SELECT `id` FROM ohrm_module WHERE name = 'performance' LIMIT 1);

INSERT INTO ohrm_screen (`name`, `module_id`, `action_url`)
VALUES ('View Performance Module', @performance_module_id, 'viewPerformanceModule');
SET
@view_performance_module_id := (SELECT LAST_INSERT_ID());

UPDATE `ohrm_menu_item`
SET `screen_id`=@view_performance_module_id
WHERE `menu_title` = 'Performance';
...
SET
@leave_apply_email_id := (SELECT `id` FROM ohrm_email WHERE `name` = 'leave.apply' LIMIT 1);
SET
@leave_assign_email_id := (SELECT `id` FROM ohrm_email WHERE `name` = 'leave.assign' LIMIT 1);
SET
@leave_approve_email_id := (SELECT `id` FROM ohrm_email WHERE `name` = 'leave.approve' LIMIT 1);
SET
@leave_cancel_email_id := (SELECT `id` FROM ohrm_email WHERE `name` = 'leave.cancel' LIMIT 1);
SET
@leave_reject_email_id := (SELECT `id` FROM ohrm_email WHERE `name` = 'leave.reject' LIMIT 1);
UPDATE `ohrm_email_processor`
SET `class_name` = 'OrangeHRM\\Leave\\Mail\\Processor\\LeaveAllocateEmailProcessor'
WHERE `email_id` = @leave_apply_email_id;
UPDATE `ohrm_email_processor`
SET `class_name` = 'OrangeHRM\\Leave\\Mail\\Processor\\LeaveAllocateEmailProcessor'
WHERE `email_id` = @leave_assign_email_id;
UPDATE `ohrm_email_processor`
SET `class_name` = 'OrangeHRM\\Leave\\Mail\\Processor\\LeaveStatusChangeEmailProcessor'
WHERE `email_id` = @leave_approve_email_id;
UPDATE `ohrm_email_processor`
SET `class_name` = 'OrangeHRM\\Leave\\Mail\\Processor\\LeaveStatusChangeEmailProcessor'
WHERE `email_id` = @leave_cancel_email_id;
UPDATE `ohrm_email_processor`
SET `class_name` = 'OrangeHRM\\Leave\\Mail\\Processor\\LeaveStatusChangeEmailProcessor'
WHERE `email_id` = @leave_reject_email_id;

UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/apply/leaveApplicationSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/apply/leaveApplicationBody.html.twig'
WHERE `email_id` = @leave_apply_email_id
  AND `recipient_role` = 'supervisor';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/apply/leaveApplicationSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/apply/leaveApplicationSubscriberBody.html.twig'
WHERE `email_id` = @leave_apply_email_id
  AND `recipient_role` = 'subscriber';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/assign/leaveAssignmentSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/assign/leaveAssignmentBody.html.twig'
WHERE `email_id` = @leave_assign_email_id
  AND `recipient_role` = 'ess';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/assign/leaveAssignmentSubjectForSupervisors.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/assign/leaveAssignmentBodyForSupervisors.html.twig'
WHERE `email_id` = @leave_assign_email_id
  AND `recipient_role` = 'supervisor';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/assign/leaveAssignmentSubscriberSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/assign/leaveAssignmentSubscriberBody.html.twig'
WHERE `email_id` = @leave_assign_email_id
  AND `recipient_role` = 'subscriber';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/approve/leaveApprovalSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/approve/leaveApprovalBody.html.twig'
WHERE `email_id` = @leave_approve_email_id
  AND `recipient_role` = 'ess';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/approve/leaveApprovalSubscriberSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/approve/leaveApprovalSubscriberBody.html.twig'
WHERE `email_id` = @leave_approve_email_id
  AND `recipient_role` = 'subscriber';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/cancel/leaveEmployeeCancellationSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/cancel/leaveEmployeeCancellationBody.html.twig'
WHERE `email_id` = @leave_cancel_email_id
  AND `recipient_role` = 'supervisor';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/cancel/leaveEmployeeCancellationSubscriberSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/cancel/leaveEmployeeCancellationSubscriberBody.html.twig'
WHERE `email_id` = @leave_cancel_email_id
  AND `recipient_role` = 'subscriber'
  AND `performer_role` = 'ess';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/cancel/leaveCancellationSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/cancel/leaveCancellationBody.html.twig'
WHERE `email_id` = @leave_cancel_email_id
  AND `recipient_role` = 'ess';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/cancel/leaveCancellationSubscriberSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/cancel/leaveCancellationSubscriberBody.html.twig'
WHERE `email_id` = @leave_cancel_email_id
  AND `recipient_role` = 'subscriber'
  AND `performer_role` IS NULL;
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/reject/leaveRejectionSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/reject/leaveRejectionBody.html.twig'
WHERE `email_id` = @leave_reject_email_id
  AND `recipient_role` = 'ess';
UPDATE `ohrm_email_template`
SET `subject` = '/orangehrmLeavePlugin/Mail/templates/en_US/reject/leaveRejectionSubscriberSubject.txt.twig',
    `body`    = '/orangehrmLeavePlugin/Mail/templates/en_US/reject/leaveRejectionSubscriberBody.html.twig'
WHERE `email_id` = @leave_reject_email_id
  AND `recipient_role` = 'subscriber';

INSERT INTO `ohrm_registration_event_queue` (`event_type`, `published`, `event_time`)
VALUES (0, 0, now());
...
@supervisor_role_id := (SELECT `id` FROM ohrm_user_role WHERE `name` = 'Supervisor' LIMIT 1);
SET
@project_admin_role_id := (SELECT `id` FROM ohrm_user_role WHERE `name` = 'ProjectAdmin' LIMIT 1);
...
VALUES ('apiv2_time_time_sheet_config', 'API-v2 Time - Time Sheet Start Day Configuration', 1, 0, 1, 0),
       ...
       ('apiv2_time_my_timesheets_entries', 'API-v2 Time - My Timesheet Entries', 1, 0, 1, 0),
       ('apiv2_time_employees_timesheets_entries', 'API-v2 Time - Employee Timesheet Entries', 1, 0, 1, 0),
       ...
       ('apiv2_time_project_activity_unique_validation', 'API-v2 Time - Project Activity Unique Validation', 1, 0, 0,
        0),
...
SET
@time_module_id := (SELECT `id` FROM ohrm_module WHERE name = 'time' LIMIT 1);

SET
@apiv2_time_time_sheet_config_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_time_sheet_config' LIMIT 1);
SET
@apiv2_time_customers_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_customers' LIMIT 1);
SET
@apiv2_time_validation_customer_name_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_validation_customer_name' LIMIT 1);
SET
@apiv2_time_project_activities_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_project_activities' LIMIT 1);
SET
@apiv2_time_projects_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_projects' LIMIT 1);
SET
@apiv2_time_project_name_validator_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name ='apiv2_time_project_name_validator' LIMIT 1);
SET
@apiv2_time_my_timesheets_entries_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_my_timesheets_entries' LIMIT 1);
SET
@apiv2_time_employees_timesheets_entries_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_employees_timesheets_entries' LIMIT 1);
SET
@apiv2_time_my_timesheet_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_my_timesheet' LIMIT 1);
SET
@apiv2_time_timesheet_action_log_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_timesheet_action_log' LIMIT 1);
SET
@apiv2_time_project_activity_unique_validation_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_project_activity_unique_validation' LIMIT 1);
SET
@apiv2_time_timesheet_comment_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_timesheet_comment' LIMIT 1);
SET
@apiv2_time_config_time_format_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_config_time_format' LIMIT 1);
SET
@apiv2_time_validation_project_activity_name_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_validation_project_activity_name' LIMIT 1);
SET
@api_v2_time_copy_activities_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'api_v2_time_copy_activities' LIMIT 1);
SET
@apiv2_time_employee_timesheets_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_employee_timesheets' LIMIT 1);
SET
@apiv2_time_employee_timesheet_list_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_employee_timesheet_list' LIMIT 1);
SET
@apiv2_time_default_timesheet_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_default_timesheet' LIMIT 1);
SET
@apiv2_time_reports_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_reports' LIMIT 1);
SET
@apiv2_time_reports_data_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_reports_data' LIMIT 1);
SET
@apiv2_time_project_admins_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_time_project_admins' LIMIT 1);
...
VALUES ('OrangeHRM\\Time\\Api\\TimeConfigPeriodAPI', @time_module_id, @apiv2_time_time_sheet_config_data_group_id),
       ...
       ('OrangeHRM\\Time\\Api\\ValidationCustomerNameAPI', @time_module_id,
        @apiv2_time_validation_customer_name_data_group_id),
       ...
       ('OrangeHRM\\Time\\Api\\ValidateProjectNameAPI', @time_module_id,
        @apiv2_time_project_name_validator_data_group_id),
       ('OrangeHRM\\Time\\Api\\MyTimesheetItemAPI', @time_module_id, @apiv2_time_my_timesheets_entries_data_group_id),
       ('OrangeHRM\\Time\\Api\\EmployeeTimesheetItemAPI', @time_module_id,
        @apiv2_time_employees_timesheets_entries_data_group_id),
       ...
       ('OrangeHRM\\Time\\Api\\ValidationProjectActivityNameAPI', @time_module_id,
        @apiv2_time_validation_project_activity_name_data_group_id),
       ('OrangeHRM\\Time\\Api\\TimesheetProjectActivityUniqueValidationAPI', @time_module_id,
        @apiv2_time_project_activity_unique_validation_data_group_id),
       ...
       ('OrangeHRM\\Time\\Api\\EmployeeTimesheetListAPI', @time_module_id,
        @apiv2_time_employee_timesheet_list_data_group_id),
...
VALUES (1, 0, 1, 0, 0, @apiv2_time_time_sheet_config_data_group_id, @admin_role_id),
       (1, 1, 1, 1, 0, @apiv2_time_customers_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @apiv2_time_customers_data_group_id, @project_admin_role_id),
       ...
       (1, 0, 0, 0, 0, @apiv2_time_project_activities_data_group_id, @ess_role_id),
       (1, 1, 1, 1, 0, @apiv2_time_project_activities_data_group_id, @project_admin_role_id),
       (1, 1, 1, 1, 0, @apiv2_time_projects_data_group_id, @admin_role_id),
       (1, 0, 0, 0, 0, @apiv2_time_projects_data_group_id, @ess_role_id),
       (1, 0, 0, 0, 0, @apiv2_time_projects_data_group_id, @project_admin_role_id),
       ...
       (1, 0, 1, 0, 1, @apiv2_time_employees_timesheets_entries_data_group_id, @admin_role_id),
       (1, 0, 1, 0, 1, @apiv2_time_employees_timesheets_entries_data_group_id, @supervisor_role_id),
       (1, 1, 1, 0, 0, @apiv2_time_my_timesheet_data_group_id, @admin_role_id),
       (1, 1, 1, 0, 0, @apiv2_time_my_timesheet_data_group_id, @supervisor_role_id),
       (1, 1, 1, 0, 0, @apiv2_time_my_timesheet_data_group_id, @ess_role_id),
       ...
       (1, 0, 0, 0, 0, @apiv2_time_project_activity_unique_validation_data_group_id, @admin_role_id),
...
UPDATE `ohrm_screen`
SET `module_id`= 5
WHERE `action_url` = 'viewCustomers';
UPDATE `ohrm_screen`
SET `module_id`= 5
WHERE `action_url` = 'viewProjects';
UPDATE `ohrm_screen`
SET `module_id`= 5
WHERE `action_url` = 'addCustomer';
UPDATE `ohrm_screen`
SET `module_id`= 5
WHERE `action_url` = 'saveProject';

INSERT INTO `ohrm_data_group` (`name`, `description`, `can_read`, `can_create`, `can_update`, `can_delete`)
VALUES ('time_project_activities', 'Time - Project Info - Projects - Activities', 1, 1, 1, 1);

SET
@time_project_activities_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'time_project_activities' LIMIT 1);
SET
@time_project_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'time_projects' LIMIT 1);
...
SET `can_update` = 0
WHERE `data_group_id` = @time_project_data_group_id
  AND `user_role_id` = @project_admin_role_id;
...
SET
@attendance_module_id := (SELECT `id` FROM ohrm_module WHERE name = 'attendance' LIMIT 1);

SET
@apiv2_attendance_configuration_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_attendance_configuration' LIMIT 1);

INSERT INTO ohrm_api_permission (`api_name`, `module_id`, `data_group_id`)
VALUES ('OrangeHRM\\Attendance\\Api\\AttendanceConfigurationAPI', @attendance_module_id,
        @apiv2_attendance_configuration_data_group_id);
...
-- Performance Module
INSERT INTO ohrm_data_group (`name`, `description`, `can_read`, `can_create`, `can_update`, `can_delete`)
VALUES ('apiv2_performance_performance-trackerId', 'tracker get by id', 1, 1, 1, 1);

SET
@performance_module_id := (SELECT `id` FROM ohrm_module WHERE name = 'performance' LIMIT 1);

 SET
@apiv2_performance_performance-trackerId_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name =
 'apiv2_performance_performance-trackerId' LIMIT 1);

INSERT INTO ohrm_api_permission (`api_name`, `module_id`, `data_group_id`)
VALUES ('OrangeHRM\\Performance\\Api\\PerformanceTrackerAPI', @performance_module_id,
...
INSERT INTO ohrm_user_role_data_group (`can_read`, `can_create`, `can_update`, `can_delete`, `self`, `data_group_id`,
                                       `user_role_id`)
VALUES (1, 1, 1, 1, 0, @apiv2_performance_performance - trackerId_data_group_id, @admin_role_id);

INSERT INTO ohrm_data_group (`name`, `description`, `can_read`, `can_create`, `can_update`, `can_delete`)
VALUES ('reviewer_list', 'Performance - reviewers list', 1, 0, 0, 0);

SET
@performance_module_id := (SELECT `id` FROM ohrm_module WHERE name = 'performance' LIMIT 1);

SET
@reviewer_list_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'reviewer_list' LIMIT 1);

INSERT INTO ohrm_api_permission (`api_name`, `module_id`, `data_group_id`)
VALUES ('OrangeHRM\\Performance\\Api\\PerformanceTrackerReviewerAPI', @performance_module_id,
        @reviewer_list_data_group_id);
...
INSERT INTO ohrm_user_role_data_group (`can_read`, `can_create`, `can_update`, `can_delete`, `self`, `data_group_id`,
                                       `user_role_id`)
VALUES (1, 0, 0, 0, 0, @reviewer_list_data_group_id, @admin_role_id);
...
@performance_module_id := (SELECT `id` FROM ohrm_module WHERE name = 'performance' LIMIT 1);
SET
@apiv2_kpi_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_kpi' LIMIT 1);
...
ALTER TABLE ohrm_kpi
    ADD CONSTRAINT FOREIGN KEY (job_title_code) REFERENCES ohrm_job_title (id) ON DELETE CASCADE;
