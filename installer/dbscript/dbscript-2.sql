...
VALUES (1, 0, 1, 0, 0, @apiv2_time_time_sheet_config_data_group_id, @admin_role_id),
       ...
       (1, 1, 1, 1, 0, @apiv2_time_project_activities_data_group_id, @supervisor_role_id),
       ...
       (1, 1, 1, 1, 0, @apiv2_time_projects_data_group_id, @supervisor_role_id),
       ...
       (1, 1, 1, 0, 0, @apiv2_time_timesheet_comment_data_group_id, @project_admin_role_id),
