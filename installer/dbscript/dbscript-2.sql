...
VALUES ('apiv2_admin_education', 'API-v2 Admin - Education', 1, 1, 1, 1),
       ...
       ('apiv2_email_configuration', 'API-v2 Admin - Email Configuration', 1, 0, 1, 0);
...
SET @apiv2_email_configuration_data_group_id := (SELECT `id` FROM ohrm_data_group WHERE name = 'apiv2_email_configuration' LIMIT 1);
...
VALUES ('OrangeHRM\\Admin\\Api\\EducationAPI', @admin_module_id, @apiv2_admin_education_data_group_id),
       ...
       ('OrangeHRM\\Admin\\Api\\EmailConfigurationAPI', @admin_module_id, @apiv2_email_configuration_data_group_id);
...
VALUES (1, 1, 1, 1, 0, @apiv2_admin_education_data_group_id, @admin_role_id),
       ...
       (1, 0, 1, 0, 0, @apiv2_email_configuration_data_group_id, @admin_role_id);
