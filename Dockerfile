...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install apache2 mysql-server libapache2-mod-php7 php7-mysql php7-gd php-pear php-apc php7-curl curl lynx-cur wget unzip supervisor ssh && \
