...
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'extractor_recruitment_AllTests::main');
}
...
if (PHPUnit_MAIN_METHOD == 'extractor_recruitment_AllTests::main') {
    extractor_recruitment_AllTests::main();
}
?>
