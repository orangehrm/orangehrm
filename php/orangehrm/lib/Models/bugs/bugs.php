...
class Bugs{
	...
	function addBugs(){
		...
		$arrFieldList[10] = "'". $this->getResolution() ."'";
		$arrFieldList[11] = "'". $this->getSource() ."'";
		$arrFieldList[12] = "'". $this->getStatus() ."'";
		$arrFieldList[13] = "'". $this->getType() ."'";
		$arrFieldList[14] = "'". $this->getWorkLog() ."'";
		
		$arrRecordsList[0] = 'id';
		$arrRecordsList[1] = 'number';
		$arrRecordsList[2] = 'created_by';
		$arrRecordsList[3] = 'date_entered';
		$arrRecordsList[4] = 'assigned_developer_id';
		$arrRecordsList[5] = 'description';
		$arrRecordsList[6] = 'found_in_release';
		$arrRecordsList[7] = 'module';
		$arrRecordsList[8] = 'name';
		$arrRecordsList[9] = 'priority';
		$arrRecordsList[10] = 'resolution';
		$arrRecordsList[11] = 'source';
		$arrRecordsList[12] = 'status';
		$arrRecordsList[13] = 'type';
		$arrRecordsList[14] = 'work_log';
