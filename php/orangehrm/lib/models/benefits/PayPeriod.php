...
class PayPeriod {
	...
	public function add() {
		...
		/*if ($result) {
			...
			throw new PayPeriodException("Error in SQL Query", PayPeriodException::ERROR_IN_DB_QUERY);
		}*/
	...
	public function update() {
		...
		if (!CommonFunctions::isValidId($this->id)) {
			throw new PayPeriodException("Invalid id", PayPeriodException::INVALID_ID);
		}
	...
	public function delete() {
		...
		if ($count !== 1) {
			throw new PayPeriodException("Error in Delete", PayPeriodException::INVALID_ROW_COUNT);
		}
	...
	public static function getPayPeriod($id) {
		...
		if ($numResults == 1) {
			...
			throw new PayPeriodException("Invalid number of results returned.", PayPeriodException::HSP_NOT_FOUND);
		} else {
			throw new PayPeriodException("Invalid number of results returned.", PayPeriodException::INVALID_ROW_COUNT);
		}
	}
...
class PayPeriodException extends Exception {
