...
/**
 * Test class for PayPeriod.
 * Generated by PHPUnit_Util_Skeleton on 2007-10-14 at 23:17:10.
 */
class PayPeriodTest extends PHPUnit_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit_Framework_TestSuite("PayPeriodTest");
    ...
    public function testCountPayPeriods() {
    	$payPeriodsCount = PayPeriod::countPayPeriods(date('Y', time()-3600*24*750));

    	$this->assertEquals(0, $payPeriodsCount);
    }

    public function testCountPayPeriods1() {
    	$payPeriodsCount = PayPeriod::countPayPeriods(date('Y'));

    	$this->assertEquals(1, $payPeriodsCount);
    }

    public function testCountPayPeriods2() {
    	$payPeriodsCount = PayPeriod::countPayPeriods(date('Y'), true);
    ...
    public function testListPayPeriods() {
		$payPeriods = PayPeriod::listPayPeriods(date('Y', time()-3600*24*750));
    ...
    public function testListPayPeriods1() {
		...
		$payPeriods = PayPeriod::listPayPeriods(date('Y'));
	...
	public function testCountCheckDates() {
		...
		$this->assertEquals(PayPeriod::countCheckDates("2008-01-01", "2008-04-01"), 3);
		$this->assertEquals(PayPeriod::countCheckDates("2007-12-01", "2008-04-01"), 3);
		$this->assertEquals(PayPeriod::countCheckDates("2005-12-01", "2008-04-01"), 3);
		$this->assertEquals(PayPeriod::countCheckDates("2008-01-25", "2008-03-31"), 2);
		$this->assertEquals(PayPeriod::countCheckDates("2008-03-31", "2008-05-31"), 0);
...
// Call PayPeriodTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == "PayPeriodTest::main") {
    PayPeriodTest::main();
}
?>
