...
class NonCashBen {
	...
	var $tableName = 'HS_HR_NONCASH_BENEFIT';
	...
	function delNonCashBenefits($arrList) {
	...
	function updateNonCashBenefits() {
	...
	function filterNonCashBenefits($getID) {
	...
	function getLastRecord() {
		...
		return $common_func->explodeString($this->singleField,"NCB");
				
		}
		
	}	
	
	function getNonCashBenCodes($id) {
	...
	function getAllNonCashBenefits() {
