...
function welcomeSubmit() {
	...
	<div id="content">
		<h2>Welcome to the OrangeHRM ver 2.1 Setup Wizard</h2>
   
      
		<p>This installer creates the OrangeHRM database tables and sets the
        configuration files that you need to start.</p>
        <p><b>N.B.</b><br/>If you have OrangeHRM 1.2 or OrangeHRM 2.0 already running and would like to upgrade to OrangeHRM 2.1, please click <a href="../upgrade.php">here</a>.</p>
        <p>
