...
<form name="frmCashBenSal" method="post" action="<?=$_SERVER['PHP_SELF']?>?uniqcode=<?=$this->getArr['uniqcode']?>&id=<?=$this->getArr['id']?>">
  <tr>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
						  <tr>
						    <td><?=$salarygid?></td>
						  	  <td><strong><?=$saldet[0][0]?></strong></td>
						  </tr>
						  <tr>
						    <td><?=$salarygname?></td>
						    <td><strong><?=$saldet[0][1]?></strong></td>
						  </tr>
                  </table></td>
...
<input type="hidden" name="txtSalGrd" value="<?=$saldet[0][0]?>">
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
						    <tr>
						             <td><?=$benefit?></td>
						             <td align="left"><input type="hidden" name="cmbCashBen" value="<?=$edit[0][0]?>"><strong>
<?
									$benlist = $this->popArr['benListAll'];
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
							<tr>
							         ...
							         <td><select <?=$locRights['add'] ? '':'disabled'?> name="cmbCashBen">
							         		<option value="0"><?=$selectben?></option>
							            <?
							            $benlist = $this->popArr['benListUnAss'];
...
<table width='100%' cellpadding='0' cellspacing='0' border='0'>
  ...
  <tr>
    ...
    <td width='100%'><h3><?=$assignedbenefits ?></h3></td>
    <td valign='top' align='right' nowrap style='padding-top:3px; padding-left: 5px;'><A href='index.php?module=Contacts&action=index&return_module=Contacts&return_action=DetailView&&print=true' class='utilsLink'></td>
  </tr>
  <tr>
  <td>
