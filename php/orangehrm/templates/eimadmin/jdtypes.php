...
<form name="frmJDTypes" method="post" action="<?=$_SERVER['PHP_SELF']?>?uniqcode=<?=$this->getArr['uniqcode']?>">
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
						  ...
						  <tr> 
						    ...
						    <td> <select name='cmbJDCatID'>
									<option value='0'><?=$selectcat?></option>
						    <?
						       $jdcatcodes = $this -> popArr['jdcatcodes'];
...
<p> 
<table width="431" border="0" cellspacing="0" cellpadding="0" ><td width="177">
<form name="frmJDTypes" method="post" action="<?=$_SERVER['PHP_SELF']?>?id=<?=$this->getArr['id']?>&uniqcode=<?=$this->getArr['uniqcode']?>">
           ...
           <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
						 <tr> 
							    <td><?=$code?></td>
							    <td> <input type="hidden" name="txtJDTypeID" value=<?=$this->getArr['id']?>><strong><?=$this->getArr['id']?></strong></td>
							  </tr>
						  <tr> 
						    <td><?=$description?></td>
