...
<form name="frmDBVersions" method="post" action="<?=$_SERVER['PHP_SELF']?>?mtcode=<?=$this->getArr['mtcode']?>">
...
<form name="frmDBVersions" method="post" action="<?=$_SERVER['PHP_SELF']?>?id=<?=$this->getArr['id']?>&mtcode=<?=$this->getArr['mtcode']?>">
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
   ...
   <tr> 
    <td>Description</td>
    <td><textarea name='txtDescription' disabled rows="3" cols="30"><?=$message[0][6]?></textarea></td>  
  </tr>
