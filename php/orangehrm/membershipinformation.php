...
require_once OpenSourceEIM . '/lib/Confs/sysConf.php';
	...
	$parent_membershipinfo = new MembershipInfo();
	$sysConst = new sysConf(); 
	$locRights=$_SESSION['localRights'];

	
if ((isset($_POST['sqlState'])) && ($_POST['sqlState'] == 'NewRecord')) {
	$parent_membershipinfo -> setMembershipInfoId($parent_membershipinfo ->getLastRecord());
	$parent_membershipinfo -> setMembershipInfoDesc(trim($_POST['txtMembershipInfoDesc']));
	$parent_membershipinfo -> setMembershipTypeId(trim($_POST['selMembershipType']));
	$message = $parent_membershipinfo ->addMembershipInfo();
	...
	if ($message) { 
		...
		$uniqcode = $_GET['uniqcode'];
		$pageID = $_GET['pageid'];
		header("Location: ./membershipinformation.php?message=$showMsg&captureState=AddMode");
	}
	
} else if ((isset($_POST['sqlState'])) && ($_POST['sqlState'] == 'UpdateRecord')) {
	
	$parent_membershipinfo -> setMembershipInfoId(trim($_POST['txtMembershipInfoId']));
	$parent_membershipinfo -> setMembershipInfoDesc(trim($_POST['txtMembershipInfoDesc']));
	$parent_membershipinfo -> setMembershipTypeId(trim($_POST['selMembershipType']));
	$message = $parent_membershipinfo ->updateMembershipInfo();
...
<?
	...
	$lastRecord = $parent_membershipinfo ->getLastRecord();
?>
...
<script>		
	...
	function addSave() {
		...
		document.frmMembershipInformation.pageID.value = "<?=$_GET['pageID']?>";
...
<table width='100%' cellpadding='0' cellspacing='0' border='0' class='moduleTitle'>
  <tr>
    <td valign='top'> </td>
    <td width='100%'><h2>Membership Information : Membership Information</h2></td>
...
<form name="frmMembershipInformation" method="post" action="./membershipinformation.php?pageid=<?=$_GET['pageID']?>&uniqcode=<?=$_GET['uniqcode']?>">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
						  <tr> 
						    ...
						    <td><input type="text" readonly="true" name="txtMembershipInfoId" value=<?=$lastRecord; ?> ></td>
						  </tr>
						  <tr> 
						  ...
						  <tr> 
						    ...
						    <? $getResultSet = $parent_membershipinfo->getMembershipTypeCodes(); 
...
<? } else if ((isset($_GET['capturemode'])) && ($_GET['capturemode'] == 'updatemode')) {
	 $message = $parent_membershipinfo ->filterMembershipInfo($_GET['id']);
?>
           ...
           <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
							  <tr> 
							    <td><strong>Code</strong></td>
							    <td><input type="text" readonly="true" name="txtMembershipInfoId" value=<?=$_GET['id'] ?> ></td>
							  </tr>
							  <tr> 
							    <td><strong>Description</strong></td>
							  	<td align="left" valign="top"> <textarea name='txtMembershipInfoDesc' rows="3" disabled tabindex='3' cols="30"><?=$message[0][1]?></textarea></td>
							  </tr>
							  <tr>
							    <td><strong>Membership Type</strong></td>
