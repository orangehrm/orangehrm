...
switch ($_SESSION['RESTORING']) {
	...
	case 2: $nextPhase = 'Phase 2';
			break;
	case 3: $nextPhase = 'Phase 3';
			break;
	case 4: $nextPhase = 'Phase 4';
			break;
...
$Phases = array('Create Database', 'Database Structure - Phase 1', 'Filling User Data', 'Database Structure - Phase 2', 'Writing the Configuration');
