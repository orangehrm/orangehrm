...
CORE_SQL_UPDATE;
        ...
        $sql[8] = "UPDATE ohrm_display_field 
        ...
        $sql[9] = "INSERT INTO `ohrm_selected_filter_field` VALUES (3, 7, 3, null, null, null)";
        
        $sql[10] = "UPDATE ohrm_composite_display_field set default_value = 'Deleted Employee'
