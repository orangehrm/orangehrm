...
function welcomeSubmit() {
	...
	<div id="content">
		...
		<p>This upgrader upgrades your exsisting OrangeHRM database to run OrangeHRM 2.2 and set the configuration files that you need to start using OrangeHRM 2.2.</p>

        <p><b>N.B.</b><br/>If you don't have previous versions of OrangeHRM running already you should install OrangeHRM 2.2, please click <a href="../install.php">here</a> to do so.</p>
        <p>
