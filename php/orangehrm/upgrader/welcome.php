...
function welcomeSubmit() {
	...
	<div id="content">
		...
		<p>This upgrader upgrades your exsisting OrangeHRM 1.2/OrangeHRM 2.0 database to run OrangeHRM 2.2 and set the configuration files that you need to start using OrangeHRM 2.2.</p>

        <p><b>N.B.</b><br/>If you don't have OrangeHRM 1.2/OrangeHRM 2.0 running already you should install OrangeHRM 2.2, please click <a href="../install.php">here</a> to do so.</p>
        <p>
