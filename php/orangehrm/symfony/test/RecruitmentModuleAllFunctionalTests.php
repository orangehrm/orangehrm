...
class PluginAllTests
{
    ...
    public static function suite() {
        ...
        /* Dao Test Cases */
//        $suite->addTestFile(dirname(__FILE__) . '/../plugins/orangehrmRecruitmentPlugin/test/functional/testcases/AddCandidateTest.php');
//        $suite->addTestFile(dirname(__FILE__) . '/../plugins/orangehrmRecruitmentPlugin/test/functional/testcases/AddVacancyTest.php');
//        $suite->addTestFile(dirname(__FILE__) . '/../plugins/orangehrmRecruitmentPlugin/test/functional/testcases/TemptTest.php');
//        $suite->addTestFile(dirname(__FILE__) . '/../plugins/orangehrmRecruitmentPlugin/test/functional/testcases/AddCandidateTest.php');
//        $suite->addTestFile(dirname(__FILE__) . '/../plugins/orangehrmRecruitmentPlugin/test/functional/testcases/ViewCandidatesTest.php');
