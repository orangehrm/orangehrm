...
<?php use_stylesheet('../orangehrmAdminPlugin/css/viewEducationSuccess'); ?>
...
<div id="saveFormDiv">
    ...
    <div class="mainHeading"><h2 id="saveFormHeading">Add Education</h2></div>
...
<?php use_javascript('../orangehrmAdminPlugin/js/viewEducationSuccess'); ?>
