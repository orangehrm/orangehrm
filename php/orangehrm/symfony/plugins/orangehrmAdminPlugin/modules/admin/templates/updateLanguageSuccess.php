            ...
            <div class="mainHeading"><h2><?php echo __("Skills : Languages")?></h2></div>
            	<form name="frmSave" id="frmSave" method="post"  action="">
                  <label for="txtLocationCode"><?php echo __("Code")?> </label>
                   <span class="formValue"><?php echo $language->getLangCode()?></span>
             		 <br class="clear"/>
                 <label for="txtLocationCode"><?php echo __("Name")?> <span class="required">*</span></label>
                     <input id="txtLanguageInfoDesc"  name="txtLanguageInfoDesc" type="text"  class="formInputText" value="<?php echo $language->getLangName()?>" tabindex="5" />
             		 <br class="clear"/>
		...
		$(document).ready(function() {
			...
			//Validate the form
			 $("#frmSave").validate({
				 ...
				 rules: {
				 	txtLanguageInfoDesc: { required: true }
				 	
			 	 },
			 	 messages: {
			 		txtLanguageInfoDesc: "<?php echo __("Name is required")?> "
