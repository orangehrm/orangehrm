...
class LeaveApprovalMailer extends orangehrmLeaveMailer {
    ...
    public function sendToApplicant() {
        ...
        if (!empty($to)) {
            ...
            try {
                ...
                $logMessage = "Leave approval email was sent to $to";
                $this->logResult('Success', $logMessage);

            } catch (Exception $e) {

                $logMessage = "Couldn't send leave approval email to $to";
