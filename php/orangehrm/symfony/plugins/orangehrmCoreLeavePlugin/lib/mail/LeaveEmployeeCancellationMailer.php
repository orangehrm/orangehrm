...
class LeaveEmployeeCancellationMailer extends orangehrmLeaveMailer {
        ...
        if ($subscription instanceof MailNotification) {
            ...
            if ($subscription->getStatus() == MailNotification::STATUS_SUBSCRIBED) {
                ...
                try {
                    ...
                    $message = new LeaveEmployeeCancellationMailContent($this->performer, $this->recipient, $this->leaveRequest, $this->leaveList, $this->requestType);
