...
class ApplyLeaveForm extends sfForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'txtFromDate' => new ohrmWidgetDatePickerNew(array(), array('id' => 'applyleave_txtFromDate')),
            'txtToDate' => new ohrmWidgetDatePickerNew(array(), array('id' => 'applyleave_txtToDate')),
