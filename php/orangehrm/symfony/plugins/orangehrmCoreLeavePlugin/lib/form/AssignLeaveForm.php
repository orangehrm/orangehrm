...
class AssignLeaveForm extends sfForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'txtFromDate' => new ohrmWidgetDatePickerNew(array(), array('id' => 'assignleave_txtFromDate')),
            'txtToDate' => new ohrmWidgetDatePickerNew(array(), array('id' => 'assignleave_txtToDate')),
