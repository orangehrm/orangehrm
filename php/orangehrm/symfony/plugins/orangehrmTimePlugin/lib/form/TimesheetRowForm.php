...
class TimesheetRowForm extends sfForm {
	...
	$widgetArray = array(
	    'toDelete' => new sfWidgetFormInputCheckbox(array(), array('class' => 'toDelete')),
            ...
            'projectActivityName' => new sfWidgetFormSelect(array('choices' => array('-1' => 'Select an  Activity...')), array('class' => 'projectActivity')),
	...
	$validatorsArray = array(
	    'toDelete' => new sfValidatorPass(array('required' => false)),
            'projectName' => new sfValidatorString(array('required' => true), array('required' => 'The Project Name is required')),
