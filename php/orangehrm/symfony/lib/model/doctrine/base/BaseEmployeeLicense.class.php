 ...
 * @method EmployeeLicense setEmpNumber()    Sets the current record's "emp_number" value
 * @method EmployeeLicense setCode()         Sets the current record's "code" value
 * @method EmployeeLicense setLicenseNo()    Sets the current record's "license_no" value
