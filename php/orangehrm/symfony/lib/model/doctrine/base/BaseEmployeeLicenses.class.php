 ...
 * @method EmployeeLicenses setEmpNumber()    Sets the current record's "empNumber" value
 * @method EmployeeLicenses setCode()         Sets the current record's "code" value
 * @method EmployeeLicenses setDate()         Sets the current record's "date" value
 * @method EmployeeLicenses setRenewalDate()  Sets the current record's "renewal_date" value
 * @method EmployeeLicenses setEmployee()     Sets the current record's "Employee" value
 * @method EmployeeLicenses setLicense()      Sets the current record's "license" value
 * 
 * @package    orangehrm
 * @subpackage model
