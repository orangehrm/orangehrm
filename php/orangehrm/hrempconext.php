...
require_once OpenSourceEIM . '/lib/Confs/sysConf.php';
	...
	$empstat = $empinfo->filterEmpJobStat($_GET['id']);

	$empconext= new EmpConExt();

if(isset($_POST['STAT']) && $_POST['STAT']=='ADD')
   {
   $empconext->setEmpId($_GET['id']);
   $empconext->setEmpConExtId($_POST['txtEmpConExtID']);
   $empconext->setEmpConExtStartDat($_POST['txtEmpConExtStartDat']);
   $empconext->setEmpConExtEndDat($_POST['txtEmpConExtEndDat']);
   $empconext->addConExt();
   }
...
<form name="frmConExt" method="post" action="./hrempconext.php?reqcode=<?=$_GET['reqcode']?>&id=<?=$_GET['id']?>">
...
if(isset($_GET['CONEXT']))
{
    $arr[0]=$_GET['id'];
    $arr[1]=$_GET['CONEXT'];
    $edit=$empconext->filterConExt($arr);
?>

         <input type="hidden" name="txtEmpID" value="<?=$_GET['id']?>">
         <input type="hidden" name="txtEmpConExtID"  value="<?=$_GET['CONEXT']?>">
<br><br>
      <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="13"><img name="table_r1_c1" src="themes/beyondT/pictures/table_r1_c1.gif" width="13" height="12" border="0" alt=""></td>
...
&nbsp;
         <input type="hidden" name="txtEmpID" value="<?=$_GET['id']?>">
         <input type="hidden" name="txtEmpConExtID"  value="<?=$empconext->getLastRecord($_GET['id'])?>">
<br><br>
      <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="13"><img name="table_r1_c1" src="themes/beyondT/pictures/table_r1_c1.gif" width="13" height="12" border="0" alt=""></td>
...
<?
$rset = $empconext ->getAssConExt($_GET['id']);

    for($c=0; $rset && $c < count($rset); $c++)
        {
        echo '<tr>';
            echo "<td><input type='checkbox' class='checkbox' name='chkdel[]' value='" . $rset[$c][1] ."'></td>";
            echo "<td><a href='./hrempconext.php?reqcode=" . $_GET['reqcode'] . "&id=" . $_GET['id']. "&CONEXT=" . $rset[$c][1] . "'>" . $rset[$c][1] . "</a></td>";
