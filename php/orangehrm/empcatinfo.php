...
<script>			
	...
	function addSave() {
		...
		if (document.frmEmpCatInfo.txtEmpCatDesc.value == '') {
			alert ("Description Cannot be a Blank Value!");
			return false;
		}
		
		document.frmEmpCatInfo.sqlState.value = "NewRecord";
		document.frmEmpCatInfo.pageID.value = "<?=$_GET['pageID']?>";
		document.frmEmpCatInfo.submit();		
	}			
	
	function clearAll() {
		document.frmEmpCatInfo.txtEmpCatDesc.value = '';
	}
</script>
...
<table width='100%' cellpadding='0' cellspacing='0' border='0' class='moduleTitle'>
  <tr>
    <td valign='top'> </td>
    <td width='100%'><h2>Employee Category : Nexus Information</h2></td>
...
<form name="frmEmpCatInfo" method="post" action="<?=$_SERVER['PHP_SELF']?>?pageid=<?=$_GET['pageID']?>&uniqcode=<?=$_GET['uniqcode']?>">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
						  <tr> 
						    ...
						    <td> <textarea name='txtEmpCatDesc' rows="3" tabindex='3' cols="30"></textarea></td>
						  </tr>
...
function edit()
{
	...
	var frm=document.frmEmpCatInfo;
//  alert(frm.elements.length);
	...
	function addUpdate() {
		...
		document.frmEmpCatInfo.sqlState.value = "UpdateRecord";
		document.frmEmpCatInfo.pageID.value = "<?=$_GET['pageID']?>";
		document.frmEmpCatInfo.submit();		
	}			
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
						  <tr> 
						    ...
						    <td><input type="text" readonly="true" name="txtEmpCatInfoID" value=<?=$_GET['id'] ?> > </td>
						  </tr>
						  <tr> 
						    <td><strong>Description</strong></td>
						  	  <td><textarea name='txtEmpCatDesc' rows="3" tabindex='3' disabled cols="30"><?=$message[0][1]?></textarea></td>
						  </tr>
