...
if ((isset($_POST['sqlState'])) && ($_POST['sqlState'] == 'NewRecord')) {
	...
	$parent_skills -> setSkillId($parent_skills ->getLastRecord());
	$parent_skills -> setSkillDescription(trim($_POST['txtSkillDesc']));
	$message = $parent_skills ->addSkills();
	...
	if ($message) { 
		...
		$uniqcode = $_GET['uniqcode'];
		$pageID = $_GET['pageID'];
		header("Location: ./skills.php?msg=$showMsg&capturemode=addmode&uniqcode=$uniqcode&pageID=$pageID");
	}
	
} else if ((isset($_POST['sqlState'])) && ($_POST['sqlState'] == 'UpdateRecord')) {

	$parent_skills -> setSkillId(trim($_POST['txtSkillID']));
	$parent_skills -> setSkillDescription(trim($_POST['txtSkillDesc']));
	$message = $parent_skills ->updateSkills();
	...
	if ($message) { 
		...
		$pageID = $_GET['pageID'];
		$id = $_GET['id'];
		header("Location: ./skills.php?msg=$showMsg&id=$id&capturemode=updatemode&uniqcode=$uniqcode&pageID=$pageID");
	}
...
<?
	...
	$lastRecord = $parent_skills ->getLastRecord();
	?>
...
<script>			
	...
	function addSave() {
		...
		document.frmSkills.pageID.value = "<?=$_GET['pageID']?>";
...
<table width='100%' cellpadding='0' cellspacing='0' border='0' class='moduleTitle'>
  <tr>
    <td valign='top'></td>
    <td width='100%'><h2>Skills : Qualification Information</h2></td>
...
<form name="frmSkills" method="post" action="./Skills.php?pageID=<?=$_GET['pageID']?>&uniqcode=<?=$_GET['uniqcode']?>">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
						  <tr> 
						    ...
						    <td> <input type="text" readonly="true" name="txtSkillID" value=<?=$lastRecord; ?> > 
						  </tr>
						  <tr> 
...
<? } else if ((isset($_GET['capturemode'])) && ($_GET['capturemode'] == 'updatemode')) {
	 $message = $parent_skills ->filterSkills($_GET['id']);
?>
           ...
           <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
							  <tr> 
							    <td><strong>Code</strong></td>
							    <td> <input type="text" readonly="true" name="txtSkillID" value=<?=$_GET['id'] ?> ></td>
							  </tr>
							  <tr> 
							    <td><strong>Description</strong></td>
