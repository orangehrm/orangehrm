...
require_once OpenSourceEIM . '/lib/Confs/sysConf.php';
	...
	$parent_memtypes = new MembershipType();
...
if ((isset($_POST['sqlState'])) && ($_POST['sqlState'] == 'NewRecord')) {
	...
	$parent_memtypes -> setMemId($parent_memtypes ->getLastRecord());
	$parent_memtypes -> setMemDescription(trim($_POST['txtMemTypeDescription']));
	$message = $parent_memtypes ->addMembershipType();
	...
	if ($message) { 
		...
		$uniqcode = $_GET['uniqcode'];
		$pageID = $_GET['pageid'];
		header("Location: ./membershiptypes.php?message=$showMsg&captureState=AddMode");
	}
	
} else if ((isset($_POST['sqlState'])) && ($_POST['sqlState'] == 'UpdateRecord')) {
	
	$parent_memtypes -> setMemId(trim($_POST['txtMemTypeID']));
	$parent_memtypes -> setMemDescription(trim($_POST['txtMemTypeDescription']));
	$message = $parent_memtypes ->updateMembershipType();
...
<?
	...
	$lastRecord = $parent_memtypes ->getLastRecord();
?>
...
<script>		
	...
	function addSave() {
		...
		document.frmMembershipTypes.pageID.value = "<?=$_GET['pageID']?>";
...
<table width='100%' cellpadding='0' cellspacing='0' border='0' class='moduleTitle'>
  <tr>
    <td valign='top'></td>
    <td width='100%'><h2>Membership Type : Membership Information</h2></td>
...
<form name="frmMembershipTypes" method="post" action="./membershiptypes.php?pageid=<?=$_GET['pageID']?>&uniqcode=<?=$_GET['uniqcode']?>">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
						  <tr> 
						    ...
						    <td> <input type="text" readonly="true" name="txtMemTypeID" value=<?=$lastRecord; ?>></td>
						  </tr>
						  <tr> 
...
<? } else if ((isset($_GET['capturemode'])) && ($_GET['capturemode'] == 'updatemode')) {
	 $message = $parent_memtypes ->filterMembershipType($_GET['id']);
?>
           ...
           <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="">
						  <tr> 
						    <td><strong>Code</strong></td>
						    <td> <input type="text" readonly="true" name="txtMemTypeID" value=<?=$_GET['id'] ?> ></td>
						  </tr>
						  <tr> 
						    <td><strong>Description</strong></td>
