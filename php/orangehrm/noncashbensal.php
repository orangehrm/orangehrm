...
require_once OpenSourceEIM . '/lib/Confs/sysConf.php';
	...
	$cashbensal = new NonCashBenSalary();
...
<table width='100%' cellpadding='0' cellspacing='0' border='0' class='moduleTitle'>
  <tr>
    <td valign='top'> &nbsp;</td>
    <td width='100%'><h2>Non Cash Benefits Assigned to Salary Grade: Benefit Information</h2></td>
...
<form name="frmCashBenSal" method="post" action="./noncashbensal.php?pageID=<?=$_GET['pageID']?>&uniqcode=<?=$_GET['uniqcode']?>&id=<?=$_GET['id']?>">
								        ...
								        echo '<tr>';
								            ...
								            for($j=0;count($benlist)>$j;$j++)
								            	if($rset[$c][1]==$benlist[$j][0])
								            	   $fname=$benlist[$j][1];
								            echo "<td><a href='./noncashbensal.php?pageID=" . $_GET['pageID'] . "&uniqcode=" . $_GET['uniqcode'] . "&id=" . $_GET['id']. "&BEN=" . $rset[$c][1] . "'>" . $fname . "</a></td>";
								            echo '<td>' . $rset[$c][2] .'</td>';
								        echo '</tr>';
								        }
