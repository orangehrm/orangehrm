...
SectionGroup /e "OrangeHRM Appliance" SecGrpOrangeHRMAppliance
    ...
    Section "OrangeHRM 2.6.9" SecOrangeHRM
...
Section "-Register the application"
      ...
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${ProductName}" "DisplayVersion" "2.6.9"
...
; Descriptions
  ...
  LangString DESC_SecOrangeHRM ${LANG_ENGLISH} "OrangeHRM 2.6.9"
