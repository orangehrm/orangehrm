...
<html>
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <div id="login">
            ...
            <?php endif; ?>
            <div id="footer" >
                <div id="link" style="<?php echo $footer ?>"><lable><a href="http://www.orangehrm.com" target="_blank">OrangeHRM</a> ver 2.6.8 &copy; OrangeHRM Inc. 2005 - 2011 All rights reserved.</lable></div>
