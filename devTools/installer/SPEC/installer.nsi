...
SectionGroup /e "OrangeHRM Appliance" SecGrpOrangeHRMAppliance
    ...
    Section "OrangeHRM 3.1.1-rc.1" SecOrangeHRM
...
Section "-Register the application"
      ...
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${ProductName}" "VersionMajor" "3.1.1-rc.1"
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${ProductName}" "VersionMinor" "2"
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${ProductName}" "DisplayVersion" "3.1.1-rc.1"
...
; Descriptions
  ...
  LangString DESC_SecOrangeHRM ${LANG_ENGLISH} "OrangeHRM 3.1.1-rc.1"
