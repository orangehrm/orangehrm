...
('Chinese (Simplified, China) - 中文（简体，中国）', 'zh-Hans-CN', 1),
('Chinese (Traditional, Taiwan) - 中文（繁體，台灣）', 'zh-Hant-TW', 1),
('Dutch - Nederlands', 'nl', 1),
('English (United States)', 'en_US', 1),
('French - Français', 'fr', 1),
('German - Deutsch', 'de', 1),
('Spanish - Español', 'es', 1),
('Spanish (Costa Rica) - Español (Costa Rica)', 'es-CR', 1);

INSERT INTO `ohrm_i18n_language` (`name`, `code`, `enabled`) VALUES
('test - TEST', 'zz_ZZ', 0);

INSERT INTO `ohrm_i18n_language` (`name`, `code`) VALUES
('Afrikaans (Namibia) - Afrikaans (Namibië)', 'af-NA'),
('Afrikaans (South Africa) - Afrikaans (Suid-Afrika)', 'af-ZA'),
('Aghem (Cameroon)', 'agq-CM'),
('Akan (Ghana)', 'ak-GH'),
('Albanian (Albania) - Albanian (Albania)', 'sq-AL'),
('Albanian (Macedonia) - Albanian (Macedonia)', 'sq-MK'),
('Amharic (Ethiopia) - Amharic (Ethiopia)', 'am-ET'),
('Arabic (Algeria) - العربية (الجزائر)', 'ar-DZ'),
('Arabic (Bahrain) - العربية (البحرين)', 'ar-BH'),
('Arabic (Chad) - العربية (تشاد)', 'ar-TD'),
('Arabic (Comoros) - العربية (جزر القمر)', 'ar-KM'),
('Arabic (Djibouti) - العربية (جيبوتي)', 'ar-DJ'),
('Arabic (Egypt) - العربية (مصر)', 'ar-EG'),
('Arabic (Eritrea) - العربية (إريتريا)', 'ar-ER'),
('Arabic (Iraq) - العربية (العراق)', 'ar-IQ'),
('Arabic (Israel) - العربية (إسرائيل)', 'ar-IL'),
('Arabic (Jordan) - العربية (الأردن)', 'ar-JO'),
('Arabic (Kuwait) - العربية (الكويت)', 'ar-KW'),
('Arabic (Lebanon) - العربية (لبنان)', 'ar-LB'),
('Arabic (Libya) - العربية (ليبيا)', 'ar-LY'),
('Arabic (Mauritania) - العربية (موريتانيا)', 'ar-MR'),
('Arabic (Morocco) - العربية (المغرب)', 'ar-MA'),
('Arabic (Oman) - العربية (عمان)', 'ar-OM'),
('Arabic (Palestinian Territories) - العربية (الأراضي الفلسطينية)', 'ar-PS'),
('Arabic (Qatar) - العربية (قطر)', 'ar-QA'),
('Arabic (Saudi Arabia) - العربية (المملكة العربية السعودية)', 'ar-SA'),
('Arabic (Somalia) - العربية (الصومال)', 'ar-SO'),
('Arabic (South Sudan) - العربية (جنوب السودان)', 'ar-SS'),
('Arabic (Sudan) - العربية (السودان)', 'ar-SD'),
('Arabic (Syria) - العربية (سوريا)', 'ar-SY'),
('Arabic (Tunisia) - العربية (تونس)', 'ar-TN'),
('Arabic (United Arab Emirates) - العربية (الإمارات العربية المتحدة)', 'ar-AE'),
('Arabic (Western Sahara) - العربية (الصحراء الغربية)', 'ar-EH'),
('Arabic (Yemen) - العربية (اليمن)', 'ar-YE'),
('Armenian (Armenia) - Հայերեն (Հայաստան)', 'hy-AM'),
('Assamese (India)', 'as-IN'),
('Asturian (Spain)', 'ast-ES'),
('Asu (Tanzania)', 'asa-TZ'),
('Azerbaijani (Cyrillic, Azerbaijan) - Azərbaycan (kiril, Azərbaycan)', 'az-Cyrl-AZ'),
('Azerbaijani (Latin, Azerbaijan) - Azərbaycan (Latın, Azərbaycan)', 'az-Latn-AZ'),
('Bafia (Cameroon)', 'ksf-CM'),
('Bambara (Mali)', 'bm-ML'),
('Bangla (Bangladesh) - বাংলা (বাংলাদেশ)', 'bn-BD'),
('Bangla (India) - বাংলা (ভারত)', 'bn-IN'),
('Basaa (Cameroon)', 'bas-CM'),
('Basque (Spain) - Basque (Espainia)', 'eu-ES'),
('Belarusian (Belarus) - Беларуская (Беларусь)', 'be-BY'),
('Bemba (Zambia)', 'bem-ZM'),
('Bena (Tanzania)', 'bez-TZ'),
('Bodo (India)', 'brx-IN'),
('Bosnian (Cyrillic, Bosnia & Herzegovina) - Bosanski (ćirilica, Bosna i Hercegovina)', 'bs-Cyrl-BA'),
('Bosnian (Latin, Bosnia & Herzegovina) - Bosanski (latinica, Bosna i Hercegovina)', 'bs-Latn-BA'),
('Breton (France)', 'br-FR'),
('Bulgarian (Bulgaria) - Български (България)', 'bg-BG'),
('Burmese (Myanmar [Burma]) - မြန်မာ (မြန်မာ [မြန်မာနိုင်ငံ])', 'my-MM'),
('Cantonese (Simplified, China) - 广东话（简体中文）', 'yue-Hans-CN'),
('Cantonese (Traditional, Hong Kong SAR China) - 粵語（繁體中文，中國香港特別行政區）', 'yue-Hant-HK'),
('Catalan (Andorra) - Català (Andorra)', 'ca-AD'),
('Catalan (France) - Català (França)', 'ca-FR'),
('Catalan (Italy) - Català (Itàlia)', 'ca-IT'),
('Catalan (Spain) - Català (Espanya)', 'ca-ES'),
...
('Chiga (Uganda)', 'cgg-UG'),
('Chinese (Simplified, Hong Kong SAR China) - 中文（简体，中国香港特别行政区）', 'zh-Hans-HK'),
('Chinese (Simplified, Macau SAR China) - 中文（简体，中国澳门特别行政区）', 'zh-Hans-MO'),
('Chinese (Simplified, Singapore) - 中文（简体，新加坡）', 'zh-Hans-SG'),
('Chinese (Traditional, Hong Kong SAR China) - 中文（繁體字，中國香港特別行政區）', 'zh-Hant-HK'),
('Chinese (Traditional, Macau SAR China) - 中文（繁體字，中國澳門特別行政區）', 'zh-Hant-MO'),
('Colognian (Germany)', 'ksh-DE'),
('Cornish (United Kingdom)', 'kw-GB'),
('Croatian (Bosnia & Herzegovina) - Hrvatska (Bosna i Hercegovina)', 'hr-BA'),
('Croatian (Croatia) - Hrvatski (Hrvatska)', 'hr-HR'),
('Czech (Czechia) - Český (Česko)', 'cs-CZ'),
('Danish (Denmark) - Dansk (Danmark)', 'da-DK'),
('Danish (Greenland) - Dansk (Grønland)', 'da-GL'),
('Duala (Cameroon)', 'dua-CM'),
('Dutch (Aruba) - Nederlands (Aruba)', 'nl-AW'),
('Dutch (Belgium) - Nederlands (België)', 'nl-BE'),
('Dutch (Caribbean Netherlands) - Nederlands (Caribisch Nederland)', 'nl-BQ'),
('Dutch (Curaçao) - Nederlands (Curaçao)', 'nl-CW'),
('Dutch (Netherlands) - Nederlands (Nederland)', 'nl-NL'),
('Dutch (Sint Maarten) - Nederlands (Sint Maarten)', 'nl-SX'),
('Dutch (Suriname) - Nederlands (Suriname)', 'nl-SR'),
...
('Estonian (Estonia) - Eesti (Eesti)', 'et-EE'),
('Ewe (Ghana)', 'ee-GH'),
('Ewe (Togo)', 'ee-TG'),
('Ewondo (Cameroon)', 'ewo-CM'),
('Faroese (Denmark)', 'fo-DK'),
('Faroese (Faroe Islands)', 'fo-FO'),
('Filipino (Philippines) - Filipino (Pilipinas)', 'fil-PH'),
('Finnish (Finland) - Suomi (Suomi)', 'fi-FI'),
('French (Algeria) - Français (Algérie)', 'fr-DZ'),
('French (Belgium) - Français (Belgique)', 'fr-BE'),
('French (Benin) - Français (Bénin)', 'fr-BJ'),
('French (Burkina Faso) - Français (Burkina Faso)', 'fr-BF'),
('French (Burundi) - Français (Burundi)', 'fr-BI'),
('French (Cameroon) - Français (Cameroun)', 'fr-CM'),
('French (Canada) - Français (Canada)', 'fr-CA'),
('French (Central African Republic) - Français (République centrafricaine)', 'fr-CF'),
('French (Chad) - Français (Tchad)', 'fr-TD'),
('French (Comoros) - Français (Comores)', 'fr-KM'),
('French (Congo - Brazzaville) (fr-CG) - Français (Congo-Brazzaville) (fr-CG)', 'fr-CG'),
('French (Congo - Kinshasa) - Français (Congo-Kinshasa)', 'fr-CD'),
("French (Côte d’Ivoire) - Français (Côte d'Ivoire)", 'fr-CI'),
('French (Djibouti) - Français (Djibouti)', 'fr-DJ'),
('French (Equatorial Guinea) - Français (Guinée équatoriale)', 'fr-GQ'),
('French (France) - France francaise', 'fr-FR'),
('French (French Guiana) - Français (Guyane française)', 'fr-GF'),
('French (French Polynesia) - Français (Polynésie française)', 'fr-PF'),
('French (Gabon) - Français (Gabon)', 'fr-GA'),
('French (Guadeloupe) - Français (Guadeloupe)', 'fr-GP'),
('French (Guinea) - Français (Guinée)', 'fr-GN'),
('French (Haiti) - Français (Haïti)', 'fr-HT'),
('French (Luxembourg) - Français (Luxembourg)', 'fr-LU'),
('French (Madagascar) - Français (Madagascar)', 'fr-MG'),
('French (Mali) - Français (Mali)', 'fr-ML'),
('French (Martinique) - Français (Martinique)', 'fr-MQ'),
('French (Mauritania) - Français (Mauritanie)', 'fr-MR'),
('French (Mauritius) - Français (Maurice)', 'fr-MU'),
('French (Mayotte) - Français (Mayotte)', 'fr-YT'),
('French (Monaco) - Français (Monaco)', 'fr-MC'),
('French (Morocco) - Français (Maroc)', 'fr-MA'),
('French (New Caledonia) - Français (Nouvelle-Calédonie)', 'fr-NC'),
('French (Niger) - Français (Niger)', 'fr-NE'),
('French (Réunion) - Français (Réunion)', 'fr-RE'),
('French (Rwanda) - Français (Rwanda)', 'fr-RW'),
('French (Senegal) - Français (Sénégal)', 'fr-SN'),
('French (Seychelles) - Français (Seychelles)', 'fr-SC'),
('French (St. Barthélemy) - Français (Saint-Barthélemy)', 'fr-BL'),
('French (St. Martin) - Français (Saint-Martin)', 'fr-MF'),
('French (St. Pierre & Miquelon) - Français (Saint-Pierre-et-Miquelon)', 'fr-PM'),
('French (Switzerland) - Français (Suisse)', 'fr-CH'),
('French (Syria) - Français (Syrie)', 'fr-SY'),
('French (Togo) - Français (Togo)', 'fr-TG'),
('French (Tunisia) - Français (Tunisie)', 'fr-TN'),
('French (Vanuatu) - Français (Vanuatu)', 'fr-VU'),
('French (Wallis & Futuna) - Français (Wallis et Futuna)', 'fr-WF'),
('Friulian (Italy)', 'fur-IT'),
('Fulah (Cameroon)', 'ff-CM'),
('Fulah (Guinea)', 'ff-GN'),
('Fulah (Mauritania)', 'ff-MR'),
('Fulah (Senegal)', 'ff-SN'),
('Galician (Spain) - Galicia (España)', 'gl-ES'),
('Ganda (Uganda)', 'lg-UG'),
('Georgian (Georgia) - Georgian (Georgia)', 'ka-GE'),
('German (Austria) - Deutsch (Österreich)', 'de-AT'),
('German (Belgium) - Deutsch (Belgien)', 'de-BE'),
('German (Germany) - Deutsches Deutschland)', 'de-DE'),
('German (Italy) - Deutsch (Italien)', 'de-IT'),
('German (Liechtenstein) - Deutsch (Liechtenstein)', 'de-LI'),
('German (Luxembourg) - Deutsch (Luxemburg)', 'de-LU'),
('German (Switzerland) - Deutsch (Schweiz)', 'de-CH'),
('Greek (Cyprus) - Ελληνικά (Κύπρος)', 'el-CY'),
('Greek (Greece) - Ελληνικά (Ελλάδα)', 'el-GR'),
('Gujarati (India) - ગુજરાતી (ભારત)', 'gu-IN'),
('Gusii (Kenya)', 'guz-KE'),
('Hausa (Ghana) - Hausa (Ghana)', 'ha-GH'),
('Hausa (Niger) - Hausa (Nijar)', 'ha-NE'),
('Hausa (Nigeria) - Hausa (Nigeria)', 'ha-NG'),
('Hawaiian (United States) - Hawaiian (United States)', 'haw-US'),
('Hebrew (Israel) - עברית (ישראל)', 'he-IL'),
('Hindi (India) - हिंदी भारत)', 'hi-IN'),
('Hungarian (Hungary) - Magyar (Magyarország)', 'hu-HU'),
('Icelandic (Iceland) - Icelandic (Iceland)', 'is-IS'),
('Igbo (Nigeria) - Igbo (Nigeria)', 'ig-NG'),
('Inari Sami (Finland)', 'smn-FI'),
('Indonesian (Indonesia) - Indonesia (Indonesia)', 'id-ID'),
('Irish (Ireland) - Gaeilge (Éire)', 'ga-IE'),
('Italian (Italy) - Italiano (Italia)', 'it-IT'),
('Italian (San Marino) - Italiano (San Marino)', 'it-SM'),
('Italian (Switzerland) - Italiano (Svizzera)', 'it-CH'),
('Italian (Vatican City) - Italiano (Città del Vaticano)', 'it-VA'),
('Japanese (Japan) - 日本語（日本）', 'ja-JP'),
...
('Kamba (Kenya)', 'kam-KE'),
('Kannada (India) - ಕನ್ನಡ (ಭಾರತ)', 'kn-IN'),
('Kashmiri (India)', 'ks-IN'),
('Kazakh (Kazakhstan) - Қазақ (Қазақстан)', 'kk-KZ'),
('Khmer (Cambodia) - ខ្មែរ (កម្ពុជា)', 'km-KH'),
('Kikuyu (Kenya)', 'ki-KE'),
('Kinyarwanda (Rwanda) - Kinyarwanda (Rwanda)', 'rw-RW'),
('Konkani (India)', 'kok-IN'),
('Korean (North Korea) - 한국어 (북한)', 'ko-KP'),
('Korean (South Korea) - 한국어 (한국)', 'ko-KR'),
('Koyra Chiini (Mali)', 'khq-ML'),
('Koyraboro Senni (Mali)', 'ses-ML'),
('Kwasio (Cameroon)', 'nmg-CM'),
('Kyrgyz (Kyrgyzstan) - Kyrgyz (Kyrgyzstan)', 'ky-KG'),
('Lakota (United States)', 'lkt-US'),
('Langi (Tanzania)', 'lag-TZ'),
('Lao (Laos) - ລາວ (ລາວ)', 'lo-LA'),
('Latvian (Latvia) - Latviešu (Latvija)', 'lv-LV'),
('Lingala (Angola)', 'ln-AO'),
('Lingala (Central African Republic)', 'ln-CF'),
('Lingala (Congo - Brazzaville)', 'ln-CG'),
('Lingala (Congo - Kinshasa)', 'ln-CD'),
('Lithuanian (Lithuania) - Lietuvių (Lietuva)', 'lt-LT'),
('Low German (Germany)', 'nds-DE'),
('Low German (Netherlands)', 'nds-NL'),
('Lower Sorbian (Germany)', 'dsb-DE'),
('Luba-Katanga (Congo - Kinshasa)', 'lu-CD'),
('Luo (Kenya)', 'luo-KE'),
('Luxembourgish (Luxembourg) - Lëtzebuergesch (Lëtzebuerg)', 'lb-LU'),
('Luyia (Kenya)', 'luy-KE'),
('Macedonian (Macedonia) - Македонски (Macedonia)', 'mk-MK'),
('Machame (Tanzania)', 'jmc-TZ'),
('Makhuwa-Meetto (Mozambique)', 'mgh-MZ'),
('Makonde (Tanzania)', 'kde-TZ'),
('Malagasy (Madagascar) - Malagasy (Madagascar)', 'mg-MG'),
('Malay (Brunei) - Melayu (Brunei)', 'ms-BN'),
('Malay (Malaysia) - Melayu (Malaysia)', 'ms-MY'),
('Malay (Singapore) - Melayu (Singapura)', 'ms-SG'),
('Malayalam (India) - മലയാളം (ഇന്ത്യ)', 'ml-IN'),
('Maltese (Malta) - Malti (Malta)', 'mt-MT'),
('Manx (Isle of Man)', 'gv-IM'),
('Marathi (India) - मराठी (भारत)', 'mr-IN'),
('Masai (Kenya)', 'mas-KE'),
('Masai (Tanzania)', 'mas-TZ'),
('Mazanderani (Iran)', 'mzn-IR'),
('Meru (Kenya)', 'mer-KE'),
('Metaʼ (Cameroon)', 'mgo-CM'),
('Mongolian (Mongolia) - Монгол улсын (Монгол)', 'mn-MN'),
('Morisyen (Mauritius)', 'mfe-MU'),
('Mundang (Cameroon)', 'mua-CM'),
('Nama (Namibia)', 'naq-NA'),
('Nepali (India) - नेपाली (भारत)', 'ne-IN'),
('Nepali (Nepal) - नेपाली (नेपाल)', 'ne-NP'),
...
('Norwegian Bokmål (Norway) - Norsk bokmål (Norge)', 'nb-NO'),
('Norwegian Bokmål (Svalbard & Jan Mayen) - Norsk bokmål (Svalbard og Jan Mayen)', 'nb-SJ'),
('Norwegian Nynorsk (Norway)', 'nn-NO'),
('Nuer (South Sudan)', 'nus-SS'),
('Nyankole (Uganda)', 'nyn-UG'),
('Odia (India) - ଓଡ଼ିଆ (ଭାରତ)', 'or-IN'),
('Oromo (Ethiopia)', 'om-ET'),
('Oromo (Kenya)', 'om-KE'),
('Ossetic (Georgia)', 'os-GE'),
('Ossetic (Russia)', 'os-RU'),
('Pashto (Afghanistan) - پښتو (افغانستان)', 'ps-AF'),
('Persian (Afghanistan) - فارسی (افغانستان)', 'fa-AF'),
('Persian (Iran) - فارسی (ایران)', 'fa-IR'),
('Polish (Poland) - Polski (Polska)', 'pl-PL'),
('Portuguese (Angola) - Português (Angola)', 'pt-AO'),
('Portuguese (Brazil) - Português (Brasil)', 'pt-BR'),
('Portuguese (Cape Verde) - Português (Cabo Verde)', 'pt-CV'),
('Portuguese (Equatorial Guinea) - Português (Guiné Equatorial)', 'pt-GQ'),
('Portuguese (Guinea-Bissau) - Português (Guiné-Bissau)', 'pt-GW'),
('Portuguese (Luxembourg) - Português (Luxemburgo)', 'pt-LU'),
('Portuguese (Macau SAR China) - Português (Macau SAR China)', 'pt-MO'),
('Portuguese (Mozambique) - Português (Moçambique)', 'pt-MZ'),
('Portuguese (Portugal) - Português (Portugal)', 'pt-PT'),
('Portuguese (São Tomé & Príncipe) - Português (São Tomé e Príncipe)', 'pt-ST'),
('Portuguese (Switzerland) - Português (Suíça)', 'pt-CH'),
('Portuguese (Timor-Leste) - Português (Timor-Leste)', 'pt-TL'),
('Punjabi (Arabic, Pakistan) - ਪੰਜਾਬੀ (ਅਰਬੀ, ਪਾਕਿਸਤਾਨ)', 'pa-Arab-PK'),
('Punjabi (Gurmukhi, India) - ਪੰਜਾਬੀ (ਗੁਰਮੁਖੀ, ਭਾਰਤ)', 'pa-Guru-IN'),
('Quechua (Bolivia)', 'qu-BO'),
('Quechua (Ecuador)', 'qu-EC'),
('Quechua (Peru)', 'qu-PE'),
('Romanian (Moldova) - Română (Moldova)', 'ro-MD'),
('Romanian (Romania) - Română (România)', 'ro-RO'),
('Romansh (Switzerland)', 'rm-CH'),
('Rombo (Tanzania)', 'rof-TZ'),
('Rundi (Burundi)', 'rn-BI'),
('Russian (Belarus) - России (Беларусь)', 'ru-BY'),
('Russian (Kazakhstan) - России (Казахстан)', 'ru-KZ'),
('Russian (Kyrgyzstan) - России (Кыргызстан)', 'ru-KG'),
('Russian (Moldova) - России (Молдова)', 'ru-MD'),
('Russian (Russia) - России (Россия)', 'ru-RU'),
('Russian (Ukraine) - России (Украина)', 'ru-UA'),
('Rwa (Tanzania)', 'rwk-TZ'),
('Sakha (Russia)', 'sah-RU'),
('Samburu (Kenya)', 'saq-KE'),
('Sango (Central African Republic)', 'sg-CF'),
('Sangu (Tanzania)', 'sbp-TZ'),
('Scottish Gaelic (United Kingdom) - Gàidhlig na h-Alba (An Rìoghachd Aonaichte)', 'gd-GB'),
('Sena (Mozambique)', 'seh-MZ'),
('Serbian (Cyrillic, Bosnia & Herzegovina) - Српски језик (Ћирилица, Босна и Херцеговина)', 'sr-Cyrl-BA'),
('Serbian (Cyrillic, Montenegro) - Српски језик (Ћирилица, Црна Гора)', 'sr-Cyrl-ME'),
('Serbian (Cyrillic, Serbia) - Српски језик (Ћирилица, Србија)', 'sr-Cyrl-RS'),
('Serbian (Latin, Bosnia & Herzegovina) - Српски (Ћирилица, Босна и Херцеговина)', 'sr-Latn-BA'),
('Serbian (Latin, Montenegro) - Српски (латински, Црна Гора)', 'sr-Latn-ME'),
('Serbian (Latin, Serbia) - Српски (латински, Србија)', 'sr-Latn-RS'),
('Shambala (Tanzania)', 'ksb-TZ'),
('Shona (Zimbabwe) - Shona (Zimbabwe)', 'sn-ZW'),
('Sichuan Yi (China)', 'ii-CN'),
('Sinhala (Sri Lanka) - සිංහල (ශ්‍රී ලංකාව)', 'si-LK'),
('Slovak (Slovakia) - Slovenskú (Slovensko)', 'sk-SK'),
('Slovenian (Slovenia) - Slovensko (Slovenija)', 'sl-SI'),
('Soga (Uganda)', 'xog-UG'),
('Somali (Djibouti) - Soomaali (Jabuuti)', 'so-DJ'),
('Somali (Ethiopia) - Soomaali (Itoobiya)', 'so-ET'),
('Somali (Kenya) - Soomaali (Kenya)', 'so-KE'),
('Somali (Somalia) - Soomaali (Soomaaliya)', 'so-SO'),
('Spanish (Argentina) - Español (Argentina)', 'es-AR'),
('Spanish (Belize) - Español (Belice)', 'es-BZ'),
('Spanish (Bolivia) - Español (Bolivia)', 'es-BO'),
('Spanish (Brazil) - Español (Brasil)', 'es-BR'),
('Spanish (Chile) - Español (Chile)', 'es-CL'),
('Spanish (Colombia) - Español (Colombia)', 'es-CO'),
('Spanish (Cuba) - Español (Cuba)', 'es-CU'),
('Spanish (Dominican Republic) - Española (República Dominicana)', 'es-DO'),
('Spanish (Ecuador) - Español (Ecuador)', 'es-EC'),
('Spanish (El Salvador) - Español (El Salvador)', 'es-SV'),
('Spanish (Equatorial Guinea) - Español (Guinea Ecuatorial)', 'es-GQ'),
('Spanish (Guatemala) - Español (Guatemala)', 'es-GT'),
('Spanish (Honduras) - Español (Honduras)', 'es-HN'),
('Spanish (Mexico) - Español (México)', 'es-MX'),
('Spanish (Nicaragua) - Español (Nicaragua)', 'es-NI'),
('Spanish (Panama) - Español (Panamá)', 'es-PA'),
('Spanish (Paraguay) - Español (Paraguay)', 'es-PY'),
('Spanish (Peru) - Español (Perú)', 'es-PE'),
('Spanish (Philippines) - Español (Filipinas)', 'es-PH'),
('Spanish (Puerto Rico) - Español (Puerto Rico)', 'es-PR'),
('Spanish (Spain) - Español (España)', 'es-ES'),
('Spanish (United States) - Español (Estados Unidos)', 'es-US'),
('Spanish (Uruguay) - Español (Uruguay)', 'es-UY'),
('Spanish (Venezuela) - Español (Venezuela)', 'es-VE'),
('Standard Moroccan Tamazight (Morocco)', 'zgh-MA'),
('Swahili (Congo - Kinshasa) - Kiswahili (Congo - Kinshasa)', 'sw-CD'),
('Swahili (Kenya) - Kiswahili (Kenya)', 'sw-KE'),
('Swahili (Tanzania) - Kiswahili (Tanzania)', 'sw-TZ'),
('Swahili (Uganda) - Kiswahili (Uganda)', 'sw-UG'),
('Swedish (Åland Islands) - Svenska (Åland)', 'sv-AX'),
('Swedish (Finland) - Svenska (Finland)', 'sv-FI'),
('Swedish (Sweden) - Svenska (Sverige)', 'sv-SE'),
...
('Taita (Kenya)', 'dav-KE'),
('Tajik (Tajikistan) - Тоҷикистон (Тоҷикистон)', 'tg-TJ'),
('Tamil (India) - தமிழ் (இந்தியா)', 'ta-IN'),
('Tamil (Malaysia) - தமிழ் (மலேஷியா)', 'ta-MY'),
('Tamil (Singapore) - தமிழ் (சிங்கப்பூர்)', 'ta-SG'),
('Tamil (Sri Lanka) - தமிழ் (இலங்கை)', 'ta-LK'),
('Tasawaq (Niger)', 'twq-NE'),
('Tatar (Russia) - Татар (Россия)', 'tt-RU'),
('Telugu (India) - తెలుగు (భారతదేశం)', 'te-IN'),
('Teso (Kenya)', 'teo-KE'),
('Teso (Uganda)', 'teo-UG'),
('Thai (Thailand) - ไทย (ไทยแลนด์)', 'th-TH'),
('Tibetan (China)', 'bo-CN'),
('Tibetan (India)', 'bo-IN'),
('Tigrinya (Eritrea)', 'ti-ER'),
('Tigrinya (Ethiopia)', 'ti-ET'),
('Tongan (Tonga)', 'to-TO'),
('Turkish (Cyprus) - Türk (Kıbrıs)', 'tr-CY'),
('Turkish (Turkey) - Türk (Türkiye)', 'tr-TR'),
('Ukrainian (Ukraine) - Український (Україна)', 'uk-UA'),
('Upper Sorbian (Germany)', 'hsb-DE'),
('Urdu (India) - اردو (بھارت)', 'ur-IN'),
('Urdu (Pakistan) - اردو (پاکستان)', 'ur-PK'),
('Uyghur (China) - ئۇيغۇر (جۇڭگو)', 'ug-CN'),
("Uzbek (Arabic, Afghanistan) - O'zbekiston (arab, Afg'oniston)", 'uz-Arab-AF'),
("Uzbek (Cyrillic, Uzbekistan) - O'zbek (kirill, O'zbekiston)", 'uz-Cyrl-UZ'),
("Uzbek (Latin, Uzbekistan) - O'zbek (Lotin, O'zbekiston)", 'uz-Latn-UZ'),
('Vai (Latin, Liberia)', 'vai-Latn-LR'),
('Vai (Vai, Liberia)', 'vai-Vaii-LR'),
('Vietnamese (Vietnam) - Việt (Việt Nam)', 'vi-VN'),
('Vunjo (Tanzania)', 'vun-TZ'),
('Walser (Switzerland)', 'wae-CH'),
('Welsh (United Kingdom) - Cymraeg (Welsh)', 'cy-GB'),
('Western Frisian (Netherlands) - Western Frysk (Nederland)', 'fy-NL'),
('Wolof (Senegal)', 'wo-SN'),
('Yangben (Cameroon)', 'yav-CM'),
('Yoruba (Benin) - Yorùbá (Benin)', 'yo-BJ'),
