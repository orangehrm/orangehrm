...
<?php 
    $steps = array(
            'dbInfo' => __('Database Info'),
            'sysCheck' => __('System Check'),
            'pluginCheck' => __('Addon Check'),
            'verInfo' => __('Version Info'),
            'dbChange' => __('Database Changes'),
            'confInfo' => __('Configuration Info'),
