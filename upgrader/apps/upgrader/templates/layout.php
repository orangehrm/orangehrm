...
<?php 
    $steps = array('dbInfo' => __('Database Info'), 'sysCheck' => __('System Check'), 'verInfo' => __('Version Info'), 'dbChange' => __('Database Changes'), 'confInfo' => __('Configuration Info'), 'registration' => __('Registration'), 'completion' => __('Completion'));
