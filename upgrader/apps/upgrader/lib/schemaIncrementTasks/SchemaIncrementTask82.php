...
class SchemaIncrementTask82 extends SchemaIncrementTask
{
    public function loadSql()
    {
        $sql[] = "UPDATE `hs_hr_config` SET `value` = '4.10' WHERE `hs_hr_config`.`key` = 'instance.version';";
