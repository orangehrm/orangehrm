...
use OrangeHRM\Recruitment\Api\CandidateRejectionAPI;
 ...
 * @group APIv2
 */
class CandidateRejectionAPITest extends EndpointIntegrationTestCase
{
    ...
    {
        $api = new CandidateRejectionAPI($this->getRequest());
    ...
    public function testUpdate(TestCaseParams $testCaseParams): void
    {
        ...
        $api = $this->getApiEndpointMock(CandidateRejectionAPI::class, $testCaseParams);
