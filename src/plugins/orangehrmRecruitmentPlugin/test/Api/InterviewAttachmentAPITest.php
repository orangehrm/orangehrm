...
use OrangeHRM\Recruitment\Api\InterviewAttachmentAPI;
 ...
 * @group APIv2
 */
class InterviewAttachmentAPITest extends EndpointIntegrationTestCase
{
    /**
    ...
    {
        return $this->getTestCases('InterviewAttachmentTestCases.yaml', 'GetAll');
    }
    ...
    {
        return $this->getTestCases('InterviewAttachmentTestCases.yaml', 'Create');
    }
    ...
    {
        return $this->getTestCases('InterviewAttachmentTestCases.yaml', 'GetOne');
    }
