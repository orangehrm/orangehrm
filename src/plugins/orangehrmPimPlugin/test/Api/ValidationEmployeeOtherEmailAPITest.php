...
class ValidationEmployeeOtherEmailAPITest extends EndpointIntegrationTestCase
{
    /**
    ...
    {
        $this->populateFixtures('EmployeeOtherEmailValidation.yml');
        $this->createKernelWithMockServices([Services::AUTH_USER => $this->getMockAuthUser($testCaseParams)]);
        $this->registerServices($testCaseParams);
        $this->registerMockDateTimeHelper($testCaseParams);
        $api = $this->getApiEndpointMock(ValidationEmployeeOtherEmailAPI::class, $testCaseParams);
