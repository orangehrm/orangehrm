...
class SlackLog
{
    ...
    /**
     * @var SlackRegistration|null
     *
     * @ORM\ManyToOne(targetEntity="OrangeHRM\Entity\SlackRegistration")
     * @ORM\JoinColumn(name="registration_id", referencedColumnName="id", nullable=true, onDelete="CASCADE")
     */
    private ?SlackRegistration $registration = null;
    ...
    public function getRegistration(): ?SlackRegistration
    {
        return $this->registration;
    }

    public function setRegistration(?SlackRegistration $registration): void
    {
