...
class BuzzFeedAPITest extends EndpointIntegrationTestCase
{
    ...
    public function testGetAll(TestCaseParams $testCaseParams): void
    {
        ...
        $api = $this->getApiEndpointMock(BuzzFeedAPI::class, $testCaseParams);
        $this->assertValidTestCase($api, 'getAll', $testCaseParams);
    }

    public function dataProviderForTestGetAll(): array
    {
        return $this->getTestCases('BuzzFeedAPITestCases.yaml', 'GetAll');
    }

    public function testCreate(): void
    {
        $api = new BuzzFeedAPI($this->getRequest());
