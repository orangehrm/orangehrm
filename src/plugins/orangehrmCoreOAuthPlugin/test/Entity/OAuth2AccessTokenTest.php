...
class OAuth2AccessTokenTest extends EntityTestCase
{
    ...
    public function testOAuth2AccessTokenEntityTest(): void
    {
        ...
        $accessToken = $this->getRepository(OAuth2AccessToken::class)->find(1);
        $this->assertEquals('Access Token', $accessToken->getAccessToken());
