...
import ClaimEmployeeAutocompleteVue from '@/orangehrmClaimPlugin/components/ClaimEmployeeAutocomplete.vue';
...
export default {
  components: {
    ...
    'claim-employee-autocomplete': ClaimEmployeeAutocompleteVue,
  },
  props: {
    empNumber: {
      type: Number,
